...
hex.js:164 E0080C9488000C946E000C946E000C946E0050C946E000C946E000C946E000C946E0060C946E000C946E00000000080002010060003040700000000000000000
hex.js:164 102040861020408001020408102001020408102000404040404040404020202020202030320303030300000000250028002B000000C0000240027002A0011241
hex.js:164 FBECFEFD8E04DEBFCDBF21E0A0E0B1E001C01D92A930AB207E1F70E94F1010C9401020C940000B61E08DE00C94810160E08DE00E94BA01368EE73E080E090E00
hex.js:164 E94F50061E08DE040E94BA0168EE73E080E090E00C94F50081F920F920FB60F9211242F933F938F9339F93AF93BF938091010190910201A091A0301B09104013
hex.js:164 091000123E0230F2D37120F40196A11DB11D05C026E8230F0296DA11DB11D2093000180930101909302012A0930301B09304018091050190910601DA0910701B
hex.js:164 09108010196A11DB11D8093C050190930601A0930701B0930801BF916AF919F918F913F912F910F900FBE0F9031F9018953FB7F89480910501909106013A0910
hex.js:164 701B091080126B5A89B05C02F3F619F00196A11DB11D3FBF6627782F892F19A2F620F711D811D911D42E0660F771FD881F991F4A95D1F70895CF92DF92EF921F
hex.js:164 F92CF93DF936B017C010E94D200EB015C114D104E104F10489F00E9400020E94AD2006C1B7D0B683E734090F381E0C81ADD108E108F108C851DC4FEACFDF91CF
hex.js:164 914FF90EF90DF90CF900895789484B58260184BD84B5816084BD85B5826085BD85B57816085BDEEE6F0E0808181608083E1E82F0E01082808182608083808181
hex.js:164 6080836E0E8F0E0808181608083E1EBF0E08081684608083E0EBF0E0808181608083EAE73F0E08081846080838081826080838081B8160808380818068808310
hex.js:164 92C10008957833081F028F4813099F08230A1F00895E8730A9F08830B9F08430D1F48091800078F7D03C0809180008F77809380000895884B58F7702C084B58F
hex.js:164 7D84BD08958091DB0008F7703C08091B0008F7D8093B000F0895CF93DF9390E0FC01E458FF4F2491DFC01E057FF4F8491882349F190E0880F5991FFC01E255FF
hex.js:164 4FA591B4918C559F4F4FC01C591D4919FB7611108C0F8948C91C209582238C93888182230AC0623051F4EF8948C91322F309583238C938881822B5888304C0F8
hex.js:164 948C91822B8C939FBFDF917CF9108950F931F93CF93DF931F92CDB72DEB7282F30E0F901E859FF4F8491F901DE458FF4F1491F901E057FF4F04910023FC9F088
hex.js:164 2321F069830E9458016981E02FFF0E0EE0FFF1FEC55FF4FA591B4919FB7FF8948C91611103C01095812301C0812B98C939FBF0F90DF91CF911F910F910895408
hex.js:164 950E941D010E94F0010E947000C0E06D0E00E9474002097E1F30E940000F9CF40895F894FFCFFF
...
(function e(t, n, r) {
	...
	1: [function(require, module, exports) {
		(function(global) {
			var Plugin, chrome, firefox;
			chrome = !! (global.chrome && global.chrome.runtime);
			firefox = !chrome;
			if (chrome) {
				Plugin = require("./lib/chrome.js").ChromePlugin;
				global.ChromeCodebender = require("./lib/chrome.js").ChromePlugin
			} else if (firefox) {
				var settings = require("./lib/settings.js").settings,
					ffapi = settings.get("firefoxapi"),
					mod = ffapi ? require("./lib/firefoxapi.js") : require("./lib/firefox.js");
				console.log("Loading firefox api:", ffapi);
				console.log("Settings:", settings.obj());
				Plugin = mod.FirefoxPlugin;
				global.FirefoxCodebender = mod.FirefoxPlugin
			} else throw Error("Unrecognized platform. Firefox and chrome supported");
			global.CodebenderPlugin = Plugin;
			global.CodebenderPlugin = Plugin;
			global.Avrdude = require("avrdudejs").Avrdude
	...
	2: [function(require, module, exports) {
		(function(global) {
			var protocols = require("avrdudejs").protocols,
			...
			function parseIfString(code, maxsize, errCb) {
				if (typeof code !== "string") return code;
				var parseResult = genericParse(code, Number(maxsize));
				if (!(code = parseResult.data())) {
					errCb("extension-client", parseResult.lastError.value);
					return null
				}
				return code
			}
			function genericParse(code, maxsize) {
				var ret = code;
				if (typeof ret !== "string") return ret;
				[HexParser, Base64Parser].some(function(Parser) {
					ret = new Parser(code, maxsize, 0);
					if (ret.data()) return true;
					return false
				});
				return ret
			}
			function Plugin(available_class) {
				var self = this;
				this.log = getLog("Plugin");
				this.log.log("New plugin.");
				this.version = null;
				this.available = new(available_class || PageAvailable)(settings.get("iframe_url"));
				this.available.onFound.modifyDispatcher(function(dispatch) {
					return function(listener, version) {
						function modifiedListener(version) {
							if (version) {
								listener(version);
								return
							}
							self.getVersion(listener)
						}
						dispatch(modifiedListener, version)
					}
				});
				global.chrome = global.chrome || {};
				this.available.onFound.addListener(function(version) {
					wrap(global.chrome, self.available.api);
					if (self.serialMonitor) {
						self.serialMonitor.disconnect()
					}
					self.api = self.available.api;
					self.serial = self.available.api.serial
				});
				this.serialMonitor = null;
				this.available.onLost.addListener(function() {
					self.close(false)
				});
				this.available.onError.addListener(function(error) {
					if (error && error.context && error.context.error && error.context.error.badVersion) {
						self.available.onFound.dispatch(error.context.error.badVersion)
					}
				});
				this.onRawMessageReceived = new Event;
				this.onLost = this.available.onLost;
				this.onFound = this.available.onFound;
				this.onError = this.available.onError
			}
			Plugin.prototype = {
				setPlatformInfo: function(info, cb) {
					this.available.api.runtime.setPlatformInfo(info, cb)
				},
				instanceId: function() {
					return this.available.connectionId()
				},
				init: function() {
					this.available.init.apply(this.available, arguments)
				},
				errorCallback: function(from, msg, status) {
					console.error("[" + from + "] ", msg, "(status: " + status + ")")
				},
				serialRead: function(port, baudrate, readCb, connectedCb) {
					var self = this,
						connected = false,
						closed = false;

					function handleCloseOrError(err) {
						var success = err.id == errors.SUCCESS.id,
							error = !success,
						...
						if (connectError) {
							if (connectedCb) connectedCb(null, err.value);
							else console.error("We got a connect-error after we connected successfully")
						}
						self.serialMonitorDisconnect()
					}
					function handleSuccessfulConnect() {
						if (closed) {
							console.warn("Connected after close was issued. Ignoring.");
							return
						}
						connected = true;
						connectedCb(null, 0)
					...
					this.serialMonitor.onConnected.addListener(handleSuccessfulConnect)
				},
				flashBootloader: function(device, protocol, communication, speed, force, delay, high_fuses, low_fuses, extended_fuses, unlock_bits, lock_bits, mcu, cb, _extraConfig) {
					...
					var _ = null,
						...
						extraConfig = toSettings(_extraConfig).parent({
					...
					var p = new HexParser(this.hexString),
						data = p.data();
					if (data === null) {
				...
				flashWithProgrammer: function(device, code, maxsize, protocol, communication, speed, force, delay, mcu, cb, _extraConfig) {
					var extraConfig = toSettings(_extraConfig).parent({
				...
				flash: function(device, code, maxsize, protocol, disable_flushing, speed, mcu, cb, _extraConfig) {
					...
					if (!(code = parseIfString(code, maxsize, cb))) return;
					var from = null,
						self = this,
						config = settings.withDefault(toSettings(_extraConfig).child({
							api: this.available.api,
							maxsize: Number(maxsize),
							protocol: protocol,
							disableFlushing: disable_flushing && disable_flushing != "false",
							speed: Number(speed) || 115200,
							mcu: mcu,
							avrdude: getMCUConf(mcu)
						})),
						...
						errorCallback = function(id, msg) {
							scheduler.setTimeout(function() {
								self.transaction = null;
								var warnOrError = id >= config.get("warningReturnValueRange")[0] && id <= config.get("warningReturnValueRange")[1] ? 1 : 0;
						...
						messageCallback = function(s) {
							...
							var msg = null;
							if (s.id == status.LEONARDO_RESET_START.id || config.get("statusLog")) {
								msg = s.toString()
							}
				...
				getVersion: function(cb) {
					var self = this,
						runtime = this.available.api.runtime;
					if (this.version) {
						cb(this.version);
						return
					}
					runtime.getManifestAsync(function(manifest) {
						if (runtime.lastError) {
							throw new Error(runtime.lastError.message || runtime.lastError)
						}
						if (!manifest) {
				...
				close: function(shutdown, cb) {
					...
					if (shutdown) {
						this.available.shutdown(cb);
						return
					}
					this.available.disconnect(cb)
				},
				debugEnable: function(verbosity) {
					if (typeof verbosity === "number") global.verbosity = verbosity
				}
			};
			module.exports.ChromePlugin = Plugin
		}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
	}, {
		"./errors.js": 3,
		"./killflash.js": 6,
	...
	3: [function(require, module, exports) {
		var sm = require("serialmonitor").errors,
			ajs = require("avrdudejs").errors,
			cl = require("corelib").errors,
			toSettings = require("corelib").toSettings,
			RetVal = require("corelib").RetVal;
		module.exports = toSettings(sm).child(cl).child(ajs).child({
	...
	4: [function(require, module, exports) {
		(function(global) {
			...
			function PluginPropertyDescriptor(pluginElement, prop) {
				...
				if (desc) Object.getOwnPropertyNames(desc).forEach(function(pp) {
					if (pp != "value" && true) {
				...
				this.get = function() {
					return pluginElement[prop]
				};
				this.set = function(val) {
					pluginElement[prop] = val
				}
			}
			function prototypeProperties(obj) {
				return Object.getOwnPropertyNames(Object.getPrototypeOf(obj))
			}
			function PluginElementWrapper() {
				var self = this;
				if (!(this.element_ = global.document.getElementById("plugin0"))) {
					this.element_ = global.document.createElement("object");
				...
				var alreadyAsync = ["flashWithProgrammer", "flash", "flashBootloader", "serialRead", "setErrorCallback", "setCallback", "saveToHex", "closeTab", "deleteTab", "sendUiMessage"];
				alreadyAsync.forEach(function(m) {
					self[m] = function() {
						var args = [].slice.call(arguments),
							i = 0,
							strargs = args.map(function(a) {
								return "args[" + i+++"]"
							}).join(", "),
				...
				prototypeProperties(this.element_).forEach(function(attr) {
					if (alreadyAsync.indexOf(attr) !== -1) return;
					if (typeof self.element_[attr] === "function") {
						self[attr] = function() {
							var args = Array.prototype.slice.call(arguments),
								cb = args[args.length - 1],
								args_ = args.slice(0, args.length - 1);
							if (typeof cb !== "function") throw Error("Last argument must be a callback");
							scheduler.setTimeout(function() {
								var retval, error = null;
								try {
									retval = self.element_[attr].apply(self.element_, args_)
								} catch (err) {
									retval = -1;
									error = err
								}
						...
						var descr = new PluginPropertyDescriptor(self.element_, attr);
			...
			FirefoxPlugin.prototype = Object.create(new PluginElementWrapper);
			FirefoxPlugin.prototype.init = function(cb) {
				var self = this;
				if (!cb) {
					this.available.init();
					if (this.element_.init) this.element_.init();
					return
				}
				this.available.init(function() {
					if (self.element_.init) self.element_.init();
					self.getVersion(cb)
				})
			};
			FirefoxPlugin.prototype.chrome = function() {
				return new NpapiChrome(this)
			};
			FirefoxPlugin.prototype.getPortsCb = function(cb) {
				var ports = this.element_.getPorts();
				scheduler.setImmediate(function() {
					cb(ports)
				})
			};
			FirefoxPlugin.prototype.availablePortsCb = function(cb) {
				var ports = this.element_.availablePorts();
				scheduler.setImmediate(function() {
					cb(ports)
				})
			};
			FirefoxPlugin.prototype.getFlashResultCb = function(cb) {
				var result = this.element_.getFlashResult();
				scheduler.setImmediate(function() {
					cb(result)
				})
			};
			FirefoxPlugin.prototype.probeUSBCb = function(cb) {
				var result = this.element_.probeUSB();
				scheduler.setImmediate(function() {
					cb(result)
				})
			};
			FirefoxPlugin.prototype.serialMonitorSetStatusCb = function(cb) {
				this.element_.serialMonitorSetStatus();
				scheduler.setImmediate(function() {
					cb()
				})
			};
			FirefoxPlugin.prototype.instanceId = function() {
				return this.element_.instance_id
			};
			FirefoxPlugin.prototype.firefoxInitCb = function(cb) {};
			FirefoxPlugin.prototype.getVersion = function(cb) {
				if (cb) cb(this.version)
			};
			module.exports.FirefoxPlugin = FirefoxPlugin
		}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
	}, {
		babelfish: 101,
		corelib: 145
	...
	5: [function(require, module, exports) {
		var ChromePlugin = require("./chrome.js").ChromePlugin,
			NpapiAvailable = require("babelfish").NpapiAvailable;

		function FirefoxPlugin() {
			ChromePlugin.call(this, NpapiAvailable)
		}
		FirefoxPlugin.prototype = Object.create(ChromePlugin.prototype);
		module.exports.FirefoxPlugin = FirefoxPlugin
	}, {
		"./chrome.js": 2,
		babelfish: 101
	...
	6: [function(require, module, exports) {
		(function(global) {
			...
			global.babelfish_killFlash = function() {
				window.currentTransaction.finalError(errors.KILLED, {
					method: "button"
				})
			};
	...
	7: [function(require, module, exports) {
		var settings = require("corelib").settings,
			DynamicSetting = require("corelib").DynamicSetting;

		function developer() {
			return new DynamicSetting(function() {
				return settings.get("developer")
			})
		}
		module.exports.settings = settings.appendDefault({
			warningReturnValueRange: [20500, 21e3],
			killButton: developer(),
			statusLog: developer(),
			verbosity: new DynamicSetting(function() {
				if (settings.get("developer")) return 5;
				return 1
			}),
			developer: false
		})
	...
	8: [function(require, module, exports) {
		var sm = require("serialmonitor").status,
			ajs = require("avrdudejs").status,
			cl = require("corelib").status,
			toSettings = require("corelib").toSettings,
			Status = require("corelib").Status;
		module.exports = toSettings(sm).child(cl).child(ajs).child({
			BLOCKING_STATES: new Status("Blocking states: {states}")
		}).obj()
	}, {
		avrdudejs: 9,
		corelib: 145,
	...
	9: [function(require, module, exports) {
		(function(global) {
			var Stk500 = require("./lib/stk500").STK500Transaction;
			var Stk500v2 = require("./lib/stk500v2").STK500v2Transaction;
			var Wiring = require("./lib/wiring.js").WiringTransaction;
			var Stk500v2Usb = require("./lib/stk500v2usb").STK500v2UsbTransaction;
			var Avr109 = require("./lib/butterfly").AVR109Transaction;
			var USBTiny = require("./lib/usbtiny").USBTinyTransaction;
			var USBAsp = require("./lib/usbasp").USBAspTransaction;
			var toSettings = require("corelib").toSettings;
			...
			module.exports.UsbAvrdudeTransaction = require("./lib/avrdudetransaction.js").UsbAvrdudeTransaction
		}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
	}, {
		"./lib/avrdudecmd.js": 10,
		"./lib/avrdudeconf.js": 11,
		"./lib/avrdudetransaction.js": 12,
		"./lib/butterfly": 13,
		"./lib/connection/errors.js": 14,
		"./lib/errors.js": 17,
		"./lib/status.js": 23,
		"./lib/stk500": 24,
		"./lib/stk500v2": 25,
	...
	10: [function(require, module, exports) {
		var proto = require("../index.js").protocols,
			getMCUConf = require("avrdudejs").getMCUConf,
			Event = require("corelib").Event,
			HexParser = require("corelib").HexParser,
			Base64Parser = require("corelib").Base64Parser,
		...
		function mkData(bin) {
			var data;
			if (data = new HexParser(bin).data()) return data;
			if (data = new Base64Parser(bin).data()) return data;
			throw Error("Couldn't parse code")
		}
		function argsToDict(tokens, dict) {
			if (!dict) dict = {};
			if (tokens.length === 0) return dict;
			if (tokens[0][0] === "-" && tokens[0][1] === "-") return handleDoubleDash(tokens, dict);
			if (tokens[0][0] === "-") return handleSingleDash(tokens, dict);
			return argsToDict(tokens.slice(1), dict)
		}
		function dset(dict, key, value) {
			dict[key] = (dict[key] || []).concat([value]);
			return dict
		}
		function handleDoubleDash(tokens, dict) {
			var flag = tokens[0].slice(2);
			if (tokens[0] < 3) throw Error("Bad argument: " + tokens[0]);
			if (tokens.length === 1 || tokens[1][0] === "-") return argsToDict(tokens.slice(1), dset(dict, flag, null));
			return argsToDict(tokens.slice(2), dset(dict, flag, tokens[1]))
		}
		function handleSingleDash(tokens, dict) {
			var flag = tokens[0][1];
			if (tokens[0] < 2) throw Error("Bad argument: " + tokens[0]);
			if (tokens[0].length > 2) return argsToDict(tokens.slice(1), dset(dict, flag, tokens[0].slice(2)));
			if (tokens.length == 1 || tokens[1][0] === "-") return argsToDict(tokens.slice(1), dset(dict, flag, null));
			return argsToDict(tokens.slice(2), dset(dict, flag, tokens[1]))
		}
		function pushToken(returning, str, tokens, current) {
			if (current.length === 0) return returning(str, tokens, current);
			return returning(str, tokens.concat([current]), "")
		}
		function tokenizeQuoted(quote, str, tokens, current) {
			if (str === "") throw Error("Expected :" + quote);
			if (str[0] === quote) return pushToken(tokenizeUnix, str.slice(1), tokens, current);
			return tokenizeQuoted(quote, str.slice(1), tokens, current + str[0])
		}
		function tokenizeUnix(str, tokens, current) {
			if (!tokens) tokens = [];
			if (!current) current = "";
			if (str === "") return pushToken(function(_, t) {
				return t
			}, str.slice(1), tokens, current);
			if (str[0] === "\\") return tokenizeUnix(str.slice(2), tokens, current + str[1]);
			if (str[0] === "'" || str[0] === '"') return pushToken(tokenizeQuoted.bind(null, str[0]), str.slice(1), tokens, current);
			if (str[0] === " ") return pushToken(tokenizeUnix, str.slice(1), tokens, current);
			return tokenizeUnix(str.slice(1), tokens, current + str[0])
		}
		function argDictToConfig(api, argsDict) {
			var mcu = argsDict.p[0],
				...
				mcuConf = getMCUConf(mcu);
			if (!mcuConf) {
				throw Error("No such MCU:" + mcu)
			}
			return {
				api: api,
				speed: Number(baudrate) || 115200,
				mcu: mcu,
				chipErase: chipErase,
		...
		function argDictToProtocol(argsDict) {
			return argsDict.c[0]
		}
		function argDictToUrl(argsDict) {
			return argsDict.U[0].split(":")[2]
		}
		function argDictToPort(argsDict) {
			return argsDict.P[0]
		}
		function getUrlText(url, cb) {
			var xhttp = new XMLHttpRequest;
			xhttp.onreadystatechange = function() {
				if (xhttp.readyState == 4 && xhttp.status == 200) cb(xhttp.responseText)
			};
			xhttp.open("GET", url, true);
			xhttp.send()
		}
		function runAvrdudeSerialLite(api, cmd, cb) {
			var dictArgs = argsToDict(tokenizeUnix(cmd).slice(1));
			getUrlText(argDictToUrl(dictArgs), function(code) {
				var trans = new(proto.serial[argDictToProtocol(dictArgs)])(argDictToConfig(api, dictArgs), cb, cb);
				trans.flash(argDictToPort(dictArgs), mkData(code))
			})
		}
		function Avrdude() {
			this.available = new AppAvailable
		}
		Avrdude.prototype = {
			cmd: function(cmd, bin, cb) {
				var self = this;
				this.available.init(function(version) {
		...
		module.exports.Avrdude = Avrdude
	}, {
		"../index.js": 9,
		avrdudejs: 9,
		babelfish: 101,
	...
	12: [function(require, module, exports) {
		var hexRep = require("corelib").hexRep,
			getLog = require("corelib").getLog,
		...
		DummyTransaction.prototype = Object.create(FiniteStateMachine.prototype);

		function AvrdudeTransaction(config, finishCallback, errorCallback, parent) {
			this.init.apply(this, arguments)
		}
		AvrdudeTransaction.prototype = Object.create(DummyTransaction.prototype);
		AvrdudeTransaction.prototype.init = function _init(config, finishCallback, errorCallback, parent) {
			this.superApply(_init, arguments);
			this.log = getLog("AvrdudeTransaction")
		};
		AvrdudeTransaction.prototype.padOrSlice = function(data, offset, length) {
			var payload;
		...
		AvrdudeTransaction.prototype.maybeCheckSignature = function(cb, _bytes) {
			var self = this,
				bytes = _bytes || [];
		...
		AvrdudeTransaction.prototype.checkSignature = function(cb, bytes) {
			var self = this;
			this.setStatus(status.CHECK_SIGNATURE);
			if (bytes.length >= 3) {
				if (bytes.toString() != self.config.avrdude.signature.toString()) {
					self.errCb(errors.SIGNATURE_FAIL, {
		...
		AvrdudeTransaction.prototype.writePageInBytes = function(offset, data, cb) {
			var self = this;
			if (data.length == 0) {
				cb();
				return
		...
		AvrdudeTransaction.prototype.writeMemory = function(mem, addr, val, cb) {
			var writeOp = "WRITE",
				self = this,
		...
		AvrdudeTransaction.prototype.readMemory = function(mem, addr, cb) {
			var readOp = "READ",
				self = this;
		...
		function chain(fnlist, endcb) {
			if (fnlist && fnlist.length <= 0) {
				endcb && endcb();
				return
			}
			fnlist[0](function() {
				scheduler.setTimeout(chain.bind(null, fnlist.slice(1), endcb))
			})
		}
		AvrdudeTransaction.prototype.setupSpecialBits = function(controlBits, cb) {
			var self = this,
					...
					if (controlBits[memName] !== null) {
						function verifyMem(cb) {
							self.readMemory(memName, addr, function(resp) {
								self.log.log("Read memory", memName, ":", hexRep(resp));
								if (resp[0] == controlBits[memName]) {
									nextCallback()
								} else {
									self.errCb(errors.SPECIAL_BIT_MEMORY_VERIFICATION, {
										respons: resp,
										memName: memName,
		...
		AvrdudeTransaction.prototype.operation = function(op, args, cb, cmd) {
		...
		AvrdudeTransaction.prototype.maybeChipErase = function(cb, cmd) {
			if (this.config.chipErase) {
				return this.chipErase(cb, cmd)
			}
			return cb()
		};
		AvrdudeTransaction.prototype.chipErase = function(cb, cmd) {
			var self = this;
			scheduler.setTimeout(function() {
		...
		AvrdudeTransaction.prototype.confirmPages = function(confirmPagesCbs, cb) {
			var self = this,
		...
		function UsbAvrdudeTransaction() {
			this.init.apply(this, arguments)
		}
		UsbAvrdudeTransaction.prototype = replacePrototype(Object.create(AvrdudeTransaction.prototype), DummyTransaction, USBTransaction);

		function SerialAvrdudeTransaction() {}
		SerialAvrdudeTransaction.prototype = replacePrototype(Object.create(AvrdudeTransaction.prototype), DummyTransaction, SerialTransaction);
		SerialAvrdudeTransaction.prototype.init = function _serialInit() {
			this.superApply(_serialInit, arguments);
			this.connectionManager = new ConnectionManager(this)
		};
		module.exports.UsbAvrdudeTransaction = UsbAvrdudeTransaction;
		module.exports.SerialAvrdudeTransaction = SerialAvrdudeTransaction
	}, {
		"./connection/serialreset.js": 16,
		"./errors.js": 17,
		"./memops.js": 21,
		"./status.js": 23,
		corelib: 30
	...
	13: [function(require, module, exports) {
		...
		AVR109Transaction.prototype = Object.create(SerialAvrdudeTransaction.prototype);
		AVR109Transaction.prototype.init = function() {
		...
		AVR109Transaction.prototype.writeMsg = function(payload) {
			var sizeBytes = storeAsTwoBytes(payload.length);
		...
		"./avrdudetransaction.js": 12,
		"./connection/magicreset.js": 15,
		"./errors.js": 17,
		"./io/butterflycodec.js": 18,
		"./status.js": 23,
		corelib: 30
	}],
	14: [function(require, module, exports) {
		var errno = require("corelib").errno,
			RetVal = require("corelib").RetVal;
	...
	15: [function(require, module, exports) {
		var FiniteStateMachine = require("corelib").FiniteStateMachine,
			scheduler = require("corelib").scheduler,
			status = require("./../status.js"),
			errors = require("./../errors.js");
		...
		function pollGetDevicesUntil(expirationTime, devList, transaction, cb) {
			...
			transaction.serial.getDevices(function(devs) {
				if (!devs) {
					transaction.errCb(errors.API_ERROR, {
		...
		MagicReset.prototype.safeSetTimeout = function(cb, timeout) {
			var self = this;
			if (this.safeTimeout) {
				this.errCb(errors.OVERLAPPING_TIMEOUTS);
				return
			}
		...
		MagicReset.prototype.magicDisconnect = function() {
			...
			this.serial.disconnect(this.magicConnectionId, function(ok) {
				...
				if (!ok) {
					self.errCb(errors.LEONARDO_MAGIC_DISCONNECT_FAIL, {
		...
		MagicReset.prototype.waitForDevice = function(timeout, fallbackCb) {
			...
			function() {
				self.errCb(errors.LEONARDO_REAPPEAR_TIMEOUT)
			};
			this.serial.getDevices(function(devs) {
		...
		MagicReset.prototype.localCleanup = function _lc(cb) {
			var callback = this.superBind(_lc, cb);
		...
		PollingDisconnect.prototype.closeDevice = function(initialDevice) {
			...
			this.serial.disconnect(this.parentState.parent.connectionId, function(ok) {
				if (!ok) {
					self.errCb(errors.LEONARDO_BOOTLOADER_DISCONNECT, {
		...
		ConnectionManager.prototype = {
			...
			closeDevice: function(cb) {
				...
				this.closed = true;
				if (!this.connector) {
					this.transaction.errCb(errors.PREMATURE_RETURN, {
	...
	16: [function(require, module, exports) {
		var SocketTransaction = require("corelib").SocketTransaction,
			getLog = require("corelib").getLog,
			scheduler = require("corelib").scheduler,
			status = require("./../status.js"),
			errors = require("./errors.js");
		...
		ControlFsm.prototype.setControls = function(cid, val, cb, _dontFail) {
			...
			if (!cid) {
				...
				self.errCb(errors.DTR_RTS_FAIL, {
		...
		SerialReset.prototype.localCleanup = function _serialCleanup(cb) {
			var self = this;
		...
		SerialReset.prototype.preconfigureConnected = function(info) {
			if (!info) {
				this.errCb(errors.PRECONFIGURE_CONNECT, {
		...
		SerialReset.prototype.finalizePreparation = function() {
			...
			this.serial.disconnect(this.preconfigureConnectionId, function(ok) {
				if (!ok) {
					self.errCb(errors.PRECONFIGURE_DISCONNECT, {
		...
		SerialReset.prototype.normalConnected = function(info) {
			if (!info) {
				this.errCb(errors.CONNECTION_FAIL, {
					devConfig: this.devConfig
				});
				return
			}
		...
		SerialReset.prototype.sync = function() {
			var self = this;
			this.drain(function() {
				self.writeThenRead(self.syncConf.request, self.transitionCb("finalizeConnect"), {
					ttl: 200
				})
			})
		};
		SerialReset.prototype.finalizeConnect = function(data) {
			if (this.syncConf && this.syncConf.response && this.syncConf.response.some(function(b, i) {
				...
				this.errCb(errors.SYNC_RESPONSE, {
	...
	17: [function(require, module, exports) {
		...
		module.exports = errno({
			...
			LEONARDO_BOOTLOADER_DISCONNECT: new RetVal(20107, "Failed to disconnect before attempting to retry connecting to a bootloader that didn't behave like caterina."),
			PREMATURE_RETURN: new RetVal(1, "Some process returned before it was supposed to."),
			DTR_RTS_FAIL: new RetVal(1001, "Failed to set DTR/RTS"),
			PRECONFIGURE_CONNECT: new RetVal(20240, "Failed to connect during preconfiguration"),
			PRECONFIGURE_DISCONNECT: new RetVal(20241, "Failed to disconnect during preconfiguration"),
	...
	18: [function(require, module, exports) {
		var CodecSocket = require("corelib").CodecSocket,
	...
	20: [function(require, module, exports) {
		...
		function createLastStarterMessage(dataBuffer, state) {
			...
			state.minMessage = 6 + (state.minPureData || 0);
			for (; tokenIndex >= 0; tokenIndex--) {
				if (dataBuffer[tokenIndex] == STKv2_TOKEN) break
			}
			if (dataBuffer.length < state.minMessage) return createBadMessage(dataBuffer, 9, "Too few bytes in buffer");
			state.lastValidTokenIndex = tokenIndex - 1;
			var startIndex = tokenIndex - 4;
			if (startIndex < 0) {
				return createBadMessage(dataBuffer, Math.max(startIndex, 0), "No message heaeder found")
			}
		...
		function createLengthMessage(dataBuffer, offset, state) {
			var length1 = dataBuffer[offset],
				length2 = dataBuffer[offset + 1],
				msgLength = length1 << 8 | length2,
				newOffset = offset + 2,
				minRemainingBytes = msgLength + 2;
			if (state.minPureData && msgLength < state.minPureData) {
				log.warn("Less data than expected:", msgLength, "!=", state.minPureData);
				return createLastStarterMessage(dataBuffer, state)
			}
			if (minRemainingBytes + newOffset > dataBuffer.length) {
				log.warn("We are expecting", minRemainingBytes + newOffset - dataBuffer.length, "more bytes for this message.");
				return createBadMessage(dataBuffer, 0, "Need more bytes")
			}
		...
		function createTokenMessage(dataBuffer, offset, state) {
			var newOffset = offset + 1;
			if (dataBuffer[offset] != STKv2_TOKEN) {
		...
		Stk500v2CodecSocket.prototype.encode = function(data) {
			var size = storeAsTwoBytes(data.length),
	...
	22: [function(require, module, exports) {
		...
		var obj779 = {
			AVRPart: "Common values for reduced core tinys",
			stk500_devcode: 0,
			resetDisposition: "dedicated",
			retryPulse: "SCK",
			signature: obj1499,
		...
		var obj751 = {
			AVRPart: "AVR XMEGA family common values",
			stk500_devcode: 0,
			resetDisposition: "dedicated",
			retryPulse: "SCK",
			signature: obj1499,
		...
		var obj401 = {
			paged: false,
			size: 1,
			min_write_delay: 16e3,
			max_write_delay: 16e3,
			readback: obj1620,
			memops: obj440
		};
		var obj400 = {
		...
		var obj281 = {
			...
			size: 2048,
			page_size: 8,
			min_write_delay: 13e3,
			max_write_delay: 13e3,
			readback: obj1620,
			memops: obj318
		};
		var obj280 = {
		...
		var obj213 = {
			...
			page_size: 128,
			num_pages: 128,
			min_write_delay: 14e3,
			max_write_delay: 14e3,
			readback: obj1622,
			memops: obj247
		};
		var obj212 = {
		...
		var obj191 = {
			...
			page_size: 256,
			num_pages: 512,
			min_write_delay: 22e3,
			max_write_delay: 56e3,
			readback: obj1622,
			memops: obj238
		};
		var obj190 = {
		...
		var obj0 = {
			"  pic32-150-128-D": obj22,
			"  pic32-250-128-B": obj17,
			"  pic32-250-128": obj20,
			"  pic32-360": obj5,
			"  pic32-340": obj75,
			"  pic32-440-128": obj19,
			...
			"  pic32-440": obj18,
			"  pic32   ": obj6,
			"  pic32-695-512-H": obj8,
			"  pic32-695-512-L": obj7,
			"  pic32-MZ-2048-ECG": obj2,
			"  pic32-MZ-2048-ECH": obj3,
			"  uc3a0512": obj781,
			"  c128    ": obj36,
			"  c32     ": obj41,
			"  c64     ": obj39,
			...
			"  x8e5    ": obj750,
			"  .xmega  ": obj751,
			"  .reduced_core_tiny": obj779,
			"  ucr2    ": obj780
		};
		module.exports = obj0
	}, {}],
	23: [function(require, module, exports) {
		var status = require("corelib").status,
			Status = require("corelib").Status;
		module.exports = status({
			CHECK_SIGNATURE: new Status("Checking signature"),
			CHECK_PAGE: new Status("Checking page at address {address}"),
			CLEANING_UP: new Status("Creaning up state"),
			CONNECTING: new Status("Connecting to: {device}"),
			ENTER_PROGMODE: new Status("Entering programming mode"),
			HARDWARE_VERSION: new Status("Getting hardware version"),
			LEAVE_PROGMODE: new Status("Leaving programming mode"),
			LEONARDO_RESET_END: new Status("Leonardo board reset successfully!"),
			LEONARDO_RESET_START: new Status("Trying to auto-reset your device. If it does not reset automatically, please reset your device manually!"),
			PRECONFIGURING: new Status("Preconfiguring serial device: {device}"),
			RESETTING: new Status("Resetting device: {device}"),
			SOFTWARE_VERSION: new Status("Getting software version"),
			START_CHECK_DATA: new Status("Starting to check data"),
			START_FLASH: new Status("Flashing device please wait..."),
			START_WRITE_DATA: new Status("Starting to write data"),
			SYNC: new Status("Syncing with the device"),
			WRITE_PAGE: new Status("Writing page to address {address}")
		})
	}, {
		corelib: 30
	}],
	24: [function(require, module, exports) {
		...
		STK500Transaction.prototype = Object.create(SerialAvrdudeTransaction.prototype);
		STK500Transaction.prototype.init = function _init() {
			this.superApply(_init, arguments);
		...
		STK500Transaction.prototype.doneWriting = function(pageSize) {
			...
			var next = this.config.checkPages ? this.transitionCb("checkPages", pageSize) : this.transitionCb("doneProgramming");
			this.writeThenRead([this.STK.GET_SYNC, this.STK.CRC_EOP], next)
		};
		STK500Transaction.prototype.checkPages = function(pageSize) {
		...
		STK500Transaction.prototype.addressMsg = function(addr) {
			var addrBytes = storeAsTwoBytes(addr / 2);
		...
		STK500Transaction.prototype.writeMsg = function(payload) {
			var flashMemoryType = 70,
				sizeBytes = storeAsTwoBytes(payload.length);
		...
		STK500Transaction.prototype.readMsg = function(size) {
			var flashMemoryType = 70,
				sizeBytes = storeAsTwoBytes(size);
	...
	25: [function(require, module, exports) {
		...
		STK500v2Transaction.prototype = Object.create(SerialAvrdudeTransaction.prototype);
		STK500v2Transaction.prototype.init = function _init(config) {
			if (typeof config.avoidTwiggleDTR === "undefined") config.avoidTwiggleDTR = false;
			this.superApply(_init, arguments);
		...
		STK500v2Transaction.prototype.cmd = function(cmd, cb) {
			if (cmd.length != 4) {
				this.errCb(errors.COMMAND_SIZE_FAIL, {
					receivedCmd: cmd
				});
				return
			}
		...
		STK500v2Transaction.prototype.programFlash = function(pageSize) {
			var next = this.config.checkPages ? this.transitionCb("checkPages", pageSize) : this.transitionCb("maybeCleanupBits");
		...
		STK500v2Transaction.prototype.doneProgramming = function() {
			...
			self.writeThenRead([17, 1, 1], function(data) {
				...
				tolerateReceiveErrors: true,
				tolerateSendErrors: true
			})
		};
			...
			this.writeThenRead(this.addressMsg(offset), function(reponse) {
				self.writeThenRead(self.writeMsg(payload), function(response) {
					if (response[0] != 19 || response[1] != 0) {
						self.errCb(errors.PAGE_WRITE_RESPONSE, {
		...
		STK500v2Transaction.prototype.addressMsg = function(address) {
			var addressBytes = storeAsFourBytes(address / 2);
	...
	26: [function(require, module, exports) {
		...
		STK500v2UsbTransaction.prototype = replacePrototype(Object.create(STK500v2Transaction.prototype), SerialAvrdudeTransaction, UsbAvrdudeTransaction);
		STK500v2UsbTransaction.prototype.init = function() {
			this.__proto__.__proto__.init.apply(this, arguments);
			this.setupAsBulk();
		...
		STK500v2UsbTransaction.prototype.sync = function(cb) {
			...
			this.writeThenRead([this.STK2.CMD_SIGN_ON], function(data) {
				if (data.toString() == expectedResp.toString()) {
					self.errCb(errors.SYNC_RESPONSE, {
		...
		STK500v2UsbTransaction.prototype.drain = function(cb) {
			...
			this.usb.resetDevice(this.handler, function(ok) {
				if (!ok) {
					self.errCb(errors.STK500V2USB_DEVICE_RESET);
					return
				}
				cb()
			})
		...
		STK500v2UsbTransaction.prototype.write = function(data, cb, kwargs) {
			...
			this.usb.bulkTransfer(this.handler, outMsg, function(outResp) {
				if (!outResp || outResp.resultCode != 0) {
					self.errCb(errors.BULK_TRANSFER, {
						sentMessage: outMsg,
						response: outResp
					});
					return
		...
		STK500v2UsbTransaction.prototype.read = function(length, cb, kwargs) {
			...
			this.usb.bulkTransfer(self.handler, inMsg, function(inResp) {
				if (!kwargs.silenceErrors && (!inResp || inResp.resultCode != 0)) {
					self.errCb(errors.BULK_RECEIVE, {
						response: inResp
					});
					return
				}
				var ret = bufToBin(inResp.data);
				cb(ret)
			})
		};
	...
	27: [function(require, module, exports) {
		...
		USBAspTransaction.prototype = Object.create(UsbAvrdudeTransaction.prototype);
		USBAspTransaction.prototype.init = function() {
			this.__proto__.__proto__.init.apply(this, arguments);
			this.setupAsControl();
		...
		USBAspTransaction.prototype.checkCapabilities = function() {
			...
			this.xferMaybe(info, function(resp) {
				...
				if (capabilities & self.UA.CAP_TPI) {
					self.errCb(errors.UNSUPPORTED_TPI, {
		...
		USBAspTransaction.prototype.infoAddress = function(offset) {
			...
			if (offset >>> 31 >> 1 != 0) {
				this.errCb(errors.ADDRESS_TOO_LONG, {
					address: offset
				});
				return null
			}
		...
		USBAspTransaction.prototype.checkBlock = function(offset, payload, done) {
			...
			this.xferMaybe(this.infoAddress(offset), function(resp) {
				...
				self.xferMaybe(infoRead, function(resp) {
					if (JSON.stringify(resp.data) != JSON.stringify(payload)) {
						self.errCb(errors.PAGE_CHECK, {
							devPage: resp.data,
							hostPage: payload,
							pageOffset: offset
	...
	28: [function(require, module, exports) {
		...
		USBTinyTransaction.prototype = Object.create(UsbAvrdudeTransaction.prototype);
		USBTinyTransaction.prototype.init = function() {
			var self = this;
			this.__proto__.__proto__.init.apply(this, arguments);
			this.setupAsControl();
			this.UT = {
		...
		USBTinyTransaction.prototype.cmd = function(cmd, cb) {
			...
			superProto.cmd.call(this, cmd, function(resp) {
				if (!ops.checkMask([null, null, cmd[1], null], resp.data)) {
					self.errCb(errors.COMMAND_CHECK, {
						cmd: cmd,
						resp: resp.data
					});
					return
	...
	29: [function(require, module, exports) {
		var Stk500v2 = require("./stk500v2").STK500v2Transaction;

		function WiringTransaction() {
			this.init.apply(this, arguments)
		}
		WiringTransaction.prototype = Object.create(Stk500v2.prototype);
		WiringTransaction.prototype.init = function _init(config) {
			if (typeof config.avoidTwiggleDTR === "undefined") config.avoidTwiggleDTR = false;
			this.superApply(_init, arguments)
		};
		module.exports.WiringTransaction = WiringTransaction
	}, {
		"./stk500v2": 25
	}],
	30: [function(require, module, exports) {
		var toSettings = require("./lib/settings.js").toSettings;
		...
		module.exports.wrap = require("./lib/wrapper.js").wrap
	}, {
		"./lib/data/base64.js": 31,
		"./lib/data/data.js": 32,
		"./lib/data/errors.js": 33,
		"./lib/data/intelhex.js": 34,
		"./lib/errno.js": 35,
		"./lib/event.js": 36,
		"./lib/io/codecsocket.js": 38,
		"./lib/io/errors.js": 39,
		"./lib/logging.js": 41,
		"./lib/scheduler.js": 42,
		"./lib/settings.js": 43,
		"./lib/status.js": 44,
		"./lib/transactions/connection/errors.js": 46,
		"./lib/transactions/connection/manager.js": 47,
		"./lib/transactions/errors.js": 48,
		"./lib/transactions/fsm.js": 49,
		"./lib/transactions/serialtransaction.js": 50,
		"./lib/transactions/sockettransaction.js": 51,
		"./lib/transactions/usbtransaction.js": 53,
		"./lib/typecheck.js": 54,
		"./lib/util.js": 55,
		"./lib/wrapper.js": 56
	}],
	31: [function(require, module, exports) {
		...
		function Parser(base64str, maxSize, offset) {
			this.base64str = base64str;
			this.maxSize = maxSize;
			this.offset = offset || 0;
			this.lastError = errors.PREMATURE_RETURN.copy({
				process: "parser"
			})
		}
		Parser.prototype = {
			...
			data: function() {
				...
				if (!ret) {
					this.lastError = errors.BASE64_ERROR;
					return null
				}
				if (this.maxSize && ret.length > this.maxSize) {
					this.lastError = errors.PROGRAM_TOO_LARGE.copy({
						maxSize: this.maxSize,
						progLength: ret.length
					});
					return null
				}
				this.lastError = errors.SUCCESS;
	...
	33: [function(require, module, exports) {
		...
		module.exports = errno({
			PREMATURE_RETURN: new RetVal(1, "Some process returned before it was supposed to."),
			BASE64_ERROR: new RetVal(1, "Bad base64 data."),
	...
	34: [function(require, module, exports) {
		...
		function Parser(hex, maxSize, offset) {
			this.resetState();
			this.hex = hex;
			this.maxSize = maxSize;
		...
		Parser.prototype = {
			...
			data: function(noSquash) {
				var self = this;
				this.resetState();
				var ret = this.hex.split("\n").reduce(function(data, line) {
					var d = data && self.parseLine(line),
						ret = d && data.layer(d.data, d.offset + self.dataOffset, true);
					return noSquash || !ret ? ret : ret.squashed()
				}, new Data);
				if (!this.endOfData && this.hex.length > 0) {
					this.lastError = errors.HEXFILE_INCOMPLETE.copy();
					return null
				}
				if (this.maxSize && ret.length > this.maxSize) {
					this.lastError = errors.PROGRAM_TOO_LARGE.copy({
			...
			parseLine: function(line) {
				...
				if (line[0] !== ":" || line.length % 2 !== 1) {
					this.lastError = errors.HEXFILE_ERROR.copy({
						line: line
					});
					return null
				}
				...
				var start = rng(1),
					...
					actualCheck = this.hexToBytes(line.substring(1, index)).reduce(function(a, b) {
						return a + b
					}, 0) & 255,
	...
	35: [function(require, module, exports) {
		var SettingsManager = require("./settings.js").SettingsManager;

		function ErrnoSettingsManager(settings) {
			SettingsManager.call(this, {});
			var self = this;
			Object.getOwnPropertyNames(settings).forEach(function(k) {
				self.set(k, settings[k])
			})
		}
		ErrnoSettingsManager.prototype = Object.create(SettingsManager.prototype);
		ErrnoSettingsManager.prototype.set = function(key, value) {
			var val;
			if (!(value instanceof RetVal)) {
				throw Error("Expected a RetVal type or an array")
			}
			val = value.copy();
			val.name = key;
			SettingsManager.prototype.set.call(this, key, val)
		};
		ErrnoSettingsManager.prototype.child = function(obj) {
			var child = obj instanceof ErrnoSettingsManager ? obj : new ErrnoSettingsManager(obj);
			return SettingsManager.prototype.child.call(this, child)
		};
		ErrnoSettingsManager.prototype.parent = null;
		var uniqueId = 1;
		...
		var errnoManager = new ErrnoSettingsManager({
		...
		function errno(obj) {
			return errnoManager.child(obj).obj()
		}
		module.exports.errnoManager = errnoManager;
	...
	36: [function(require, module, exports) {
		...
		Event.prototype = {
			...
			addListener: function(cb, config) {
				if (typeof cb !== "function" || this.listeners.some(function(l) {
					return l === cb
				})) {
					return
				}
			...
			modifyDispatcher: function(modifier) {
				var id = function(l) {
						return l.apply(null, [].slice.call(arguments, 1))
					};
				this.dispatcher = modifier(this.dispatcher || id)
			}
		};

		function indirectEvent(parentEvent) {
			var ret = {};
			Object.defineProperty(ret, "listeners", {
				enumerable: true,
				get: function() {
					return this.__proto__.listeners
				}
			});
			ret.addListener = null;
			ret.removeListener = null;
			ret.__proto__ = parentEvent;
			return ret
		}
		module.exports.Event = Event;
		module.exports.IndirectEvent = indirectEvent
	}, {
		"./scheduler.js": 42
	}],
	37: [function(require, module, exports) {
		...
		function Buffer(connectionId, api) {
			var self = this;
			this.serial = new SerialIo(api);
			this.onError = new Event;
			this.serial.onReceiveError.addListener(function(connectionId, error) {
				if (connectionId !== self.state.connectionId) return;
				self.serial.flush(connectionId, function() {
					self.onError.dispatch(error)
				})
			});
		...
		Buffer.prototype = {
			setTolerateErrors: function(val) {
				if (val) {
					this.serial.tolerateErrorsOn[this.state.connectionId] = true;
					return
				}
				delete this.serial.tolerateErrorsOn[this.state.connectionId]
			},
			update: function(conf) {
				if (this.closed) {
					this.onError.dispatch(errors.UPDATE_CLOSED_BUFFER);
					return
				}
			...
			dataBuffer: function() {
				if (this.closed) {
					this.onError.dispatch(errors.READ_CLOSED_BUFFER);
					return null
				}
			...
			close: function() {
				if (this.closed) {
					this.onError.dispatch(errors.CLOSE_CLOSED_BUFFER);
					return
				}
	...
	38: [function(require, module, exports) {
		...
		function ReadOperation(buffer, decodeCb, finishCb, config, errorCb) {
			...
			this.timeoutHandle = scheduler.setTimeout(function() {
				self.log.log("Failed read operation (id: ", self.id, "ttl:", ttl, ").", "Tolerate:", !! self.config.tolerateReceiveErrors);
				if (self.config.tolerateReceiveErrors) {
					self.close();
					self.finishCallback([]);
					return
				}
				self.close();
				self.errorCb(errors.READER_TIMEOUT)
			}, ttl);
			if (this.config.tolerateReceiveErrors) this.buffer.setTolerateErrors(true)
		}
		ReadOperation.prototype = {
			...
			gotBytes: function() {
				if (this.closed) {
					this.errorCb(errors.MESSAGE_ON_CLOSED_READ_OPERTION);
					return
				}
		...
		function CodecSocket(connectionId, api) {
			var self = this;
			...
			this.buffer.onError.addListener(function() {
				self.onError.dispatch.apply(self.onError, arguments)
			});
			this.state = {};
		...
		CodecSocket.prototype = {
			...
			decode: function(dataBuffer, config) {
			...
			justWrite: function(data, cb, config) {
				...
				this.buffer.serial.send(this.connectionId, message, cb)
			},
			writeThenRead: function(data, cb, config) {
				var self = this,
					handle = function(ok, errResp) {
						if (ok) return;
						if (errResp.error && (config || {}).tolerateSendErrors) {
							self.log.warn("Send resp:", errResp);
							self.state.readOperation.close();
							cb([]);
							return
						}
						self.cancelRead();
						self.onError.dispatch(errors.API_ERROR.copy({
							method: "serial.send",
							sendResp: errResp
						}))
					};
				...
				this.state.readOperation = new ReadOperation(this.buffer, this.decode.bind(this), cb, config, self.onError.dispatch.bind(self.onError));
			...
			drain: function(cb) {
				var self = this;
				if (this.closed) {
					this.onError.dispatch(errors.DRAIN_CLOSED_CODEC);
					return
				}
				self.buffer.update({
					dataBuffer: []
	...
	39: [function(require, module, exports) {
		...
		var errors = {
			...
			LISTENER_REGISTRATION_TIMEOUT: new RetVal(20222, "Listeners took too long to get registered to the backend.")
		};
		["disconnected", "timeout", "device_lost", "break", "frame_error", "overrun", "buffer_overflow", "parity_error", "system_error"].forEach(function(err, i) {
			errors["API_ERROR_" + err] = new RetVal(202220 + i, "Got error from api:" + err)
		});
		module.exports = errno(errors)
	}, {
		"./../errno.js": 35
	}],
	40: [function(require, module, exports) {
		...
		function errorLookup(err) {
			var error = errors["API_ERROR_" + err];
			if (!error) return errors.UNKNOWN_ERROR;
			return error
		}
		function SerialIo(api) {
			var self = this;
			...
			this.handlers = {
				onReceiveErrorCb: function _onReceiveErrorCb(err) {
					if (self.tolerateErrorsOn[err.connectionId]) {
						self.onReceive.dispatch(err.connectionId, []);
						return
					}
					self.onReceiveError.dispatch(err.connectionId, errorLookup(err.error))
				},
		...
		SerialIo.prototype = {
			send: function(connectionId, data, cb, retries) {
				var self = this;
				retries = typeof retries === "number" ? retries : 100;
				if (retries <= 0) {
					this.onReceiveError.dispatch(errors.LISTENER_REGISTRATION_TIMEOUT);
					return
				}
				if (this.closed) {
					this.onReceiceError.dispatch(errors.SENDING_ON_CLOSED_SERIAL);
					return
				}
				if (!this.api.onReceive.hasListener || !this.api.onReceiveError.hasListener || this.api.onReceive.hasListener(this.handlers.onReceiveCb) && this.api.onReceive.hasListener(this.handlers.onReceiveCb)) {
					this.sendUnsafe(connectionId, data, cb, retries--);
					return
				}
				scheduler.setTimeout(function() {
					self.send(connectionId, data, cb)
				})
			},
			sendUnsafe: function(connectionId, data, cb) {
				if (data.length <= 0) {
					cb(true);
					return
				}
				...
				this.api.send(connectionId, realData, function(resp) {
					if (!resp || resp.bytesSent <= 0 || resp.error) {
						cb(false, resp);
						return
					}
					self.sendUnsafe(connectionId, data.slice(resp.bytesSent), cb)
				})
			},
			flush: function(connectionId, cb) {
				this.api.flush(connectionId, cb)
			},
			close: function() {
				if (this.closed) {
					this.onReceiveError(errors.CLOSING_CLOSED_SERIAL);
					return
				}
	...
	42: [function(require, module, exports) {
		(function(global) {
			...
			TestAsync.prototype.idleRenew = function() {
				var self = this;
				if (!this.capHandle) this.capHandle = global.setTimeout(function() {
					self.capHandle = null;
					self.idleCap()
				})
			};
	...
	43: [function(require, module, exports) {
		(function(global) {
			function DynamicSetting(cb) {
				this.cb = cb
			}
			DynamicSetting.prototype = {
				_isDynamicSetting: true
			};
			...
			SettingsManager.prototype = {
				...
				get: function(key, _default) {
					...
					var ret = this.settings[key];
					if (ret && ret._isDynamicSetting) return ret.cb();
					return ret
				},
				keys: function() {
			...
			function GetSettingsManager() {
				...
				if (this.settings.managers) debugger
			}
			...
			MuxSettingsManager.prototype.addParent = function(manager) {
				this.managers.push(manager);
				return this
			}, MuxSettingsManager.prototype.addChild = function(manager) {
				this.managers = [toSettings(manager)].concat(this.managers);
				return this
			...
			function toSettings(obj) {
				...
				if (obj._isSettingsManager) return obj;
				return new SettingsManager(obj)
			}
			global.babelfishSettings = global.babelfishSettings || {};
			...
			function ExternalSettings(dfs) {
				MuxSettingsManager.call(this, [global._browserSettings, dfs, global._corelibSettings])
			}
			ExternalSettings.prototype = Object.create(MuxSettingsManager.prototype);
			ExternalSettings.prototype.withDefault = function(setting) {
				return new ExternalSettings(this.defaultSettings().child(setting))
			};
			ExternalSettings.prototype.appendDefault = function(setting) {
				this.defaultSettings().addChild(setting);
				return this
			};
			ExternalSettings.prototype.withDefault = function(setting) {
				return new ExternalSettings(this.defaultSettings().child(setting))
			};
			ExternalSettings.prototype.defaultSettings = function() {
	...
	44: [function(require, module, exports) {
		...
		function Status(message, timestamp, id, context) {
			this.context = context || null;
			this.message = message;
			this.timestamp = timestamp || null;
			this.id = typeof id === "number" ? id : getUniqueId("status")
		}
		Status.prototype = {
			toCrazyLog: function() {
				return {
			...
			copy: function(context) {
				return new Status(this.message, scheduler.now(), this.id, context || this.context)
			},
			toString: function() {
		...
		var statusManager = toSettings({});

		function status(obj) {
			return statusManager.child(obj).obj()
		}
	...
	45: [function(require, module, exports) {
		...
		function Super() {}
		Super.prototype = {
			getSuper: function(selfFn) {
				var pos = getPosition(this, selfFn),
					sup;
				if (!pos) return null;
				sup = Object.create(Object.getPrototypeOf(pos.object));
				return sup[pos.key]
			},
			superApply: function(method, args) {
				var fn = this.getSuper(method);
				if (!fn) return null;
				return fn.apply(this, args)
			},
			superCall: function(fn, varArgs) {
				return this.superApply(fn, [].slice.call(arguments, 1))
			},
			superBind: function(fn, varArgs) {
				return this.superApply.bind(this, fn, [].slice.call(arguments, 1))
			}
		};
	...
	46: [function(require, module, exports) {
		...
		module.exports = errno({
			CONNECTION_FAIL: new RetVal(36e3, "Failed to connect to serial for flashing."),
			DISCONNECT_FAIL: new RetVal(20099, "Failed to disconnect from serial")
		})
	}, {
		"./../../errno.js": 35
	}],
	47: [function(require, module, exports) {
		...
		ConnectionManager.prototype = {
			openDevice: function(dev, speed, msg, cb) {
				...
				api.serial.connect(dev, {
					bitrate: speed,
					name: dev
				}, function(info) {
					if (!info) {
						self.transaction.errCb(errors.CONNECTION_FAIL);
						return
					}
					self.transaction.setConnectionId(info.connectionId);
					cb(info.connectionId)
				})
			},
			closeDevice: function(cb) {
				var api = this.transaction.config.api,
				...
				api.serial.disconnect(cid, function(ok) {
					if (!ok) {
						self.transaction.errCb(errors.DISCONNECT_FAIL);
						return
					}
					cb()
				})
	...
	48: [function(require, module, exports) {
		...
		module.exports = errno({
			...
			CONNECTION_FAIL: new RetVal(36e3, "Failed to connect to serial for flashing."),
			DISCONNECT_FAIL: new RetVal(1, "Failed generic disconnect."),
			READ_ERROR: new RetVal(2e5, "There was an error reading"),
			...
			NO_SOCKET: new RetVal(202175, "Socket was lost."),
	...
	49: [function(require, module, exports) {
		...
		function TransitionConfig(conf) {
			...
			this.fallbackCb = conf.fallbackCb ||
			function(cb) {
				cb()
			};
		...
		FiniteStateMachine.prototype = Object.create(Super.prototype);
		FiniteStateMachine.prototype.init = function(config, finishCallback, errorCallback, parent) {
			var self = this;
			this.state = null;
		...
		FiniteStateMachine.prototype.setStatus = function(status, context) {
			this.onStatusChange.dispatch(status, context)
		};
		FiniteStateMachine.prototype.dead = function() {
			if (this.parentState) return this._dead || this.parentState.parent.dead();
			return this._dead
		}, FiniteStateMachine.prototype.child = function(type, cb) {
			return new type(this.config, cb, this.errCb.bind(this), this)
		};
		FiniteStateMachine.prototype.refreshTimeout = function() {
			var self = this;
			if (this.parentState) {
		...
		FiniteStateMachine.prototype.errCb = function(retval, context) {
			var self = this,
				retryConf = null,
				ctx = context || {};
		...
		FiniteStateMachine.prototype.finalError = function(retval, context) {
			var self = this;
		...
		FiniteStateMachine.prototype.transitionConf = function(conf) {
			var self = this;
			if (this.dead()) {
				...
				this.log.log("Jumping to state '", conf.state, "' arguments:", conf.args, "BLOCKED", this.dead_ ? "(dead parent)" : "(dead)");
				return
			}
			this.refreshTimeout();
		...
		FiniteStateMachine.prototype.transition = function(stateOrConf, varArgs) {
		...
		FiniteStateMachine.prototype.transitionCb = function(stateOrConf, varArgs) {
			var self = this,
		...
		FiniteStateMachine.prototype.cleanup = function(callback) {
			if (this._dead) {
				return
			}
			this._dead = true;
		...
		FiniteStateMachine.prototype.localCleanup = function(cb) {
	...
	50: [function(require, module, exports) {
		...
		function SerialTransaction(config, finishCallback, errorCallback, parent) {
			if (typeof config.avoidTwiggleDTR === "undefined") config.avoidTwiggleDTR = true;
			this.init.apply(this, arguments)
		}
		SerialTransaction.prototype = Object.create(SocketTransaction.prototype);
		SerialTransaction.prototype.init = function _init(config, finishCallback, errorCallback, parent) {
			this.superApply(_init, arguments);
		...
		SerialTransaction.prototype.localCleanup = function _localCleanup(callback) {
			var self = this;
			this.disconnect(function() {
				self.superCall(_localCleanup, callback)
			})
		};
			...
			this.serial.getConnections(function(cnx) {
				forEachWithCallback(cnx, function(c, next) {
					...
					self.serial.disconnect(c.connectionId, function(ok) {
						if (!ok) {
							self.errCb(errors.FORCE_DISCONNECT_FAIL, {
								device: name
							})
						} else {
		...
		"./../logging.js": 41,
		"./../util": 55,
		"./connection/manager.js": 47,
		"./errors.js": 48,
		"./sockettransaction.js": 51
	}],
	51: [function(require, module, exports) {
		...
		SocketTransaction.prototype = Object.create(FiniteStateMachine.prototype);
		SocketTransaction.prototype.init = function _init(config, finishCallback, errorCallback, parent) {
			this.superApply(_init, arguments);
		...
		SocketTransaction.prototype.errCb = function(err, ctx) {
			...
			context.initalLastError = this.config && this.config.api && this.config.api.runtime && this.config.api.runtime.lastError;
			this.serial.getConnections(function(cnx) {
				...
				if (!currentConnection) {
					...
					context.availableConnections = cnx.map(function(c) {
		...
		SocketTransaction.prototype.localCleanup = function _localCleanup(callback) {
		...
		SocketTransaction.prototype.setSocket = function(socket) {
			...
			this._codecsocket.onError.addListener(this.boundErrCb);
		...
		SocketTransaction.prototype.writeThenRead = function(data, cb, config) {
			...
			if (!socket) {
				self.errCb(errors.NO_SOCKET);
				return
			}
			socket.writeThenRead(data, function(data) {
				if (!data) {
					self.errCb(errors.READ_ERROR);
					return
				}
				cb(data)
			}, config)
	...
	52: [function(require, module, exports) {
		...
		module.exports = status({
			BLOCKING_STATES: new Status("Blocking states {states}"),
			TRANSITION: new Status("Jumping to {state}: {args}")
		})
	}, {
		"./../status.js": 44
	}],
	53: [function(require, module, exports) {
		...
		function USBTransaction(config, finishCallback, errorCallback, parent) {
			this.init.apply(this, arguments)
		}
		USBTransaction.prototype = Object.create(FiniteStateMachine.prototype);
		USBTransaction.prototype.init = function _init(config, finishCallback, errorCallback, parent) {
			this.superApply(_init, arguments);
						...
						if (ep.direction == direction) {
							self.usb.claimInterface(self.handler, iface.interfaceNumber, function() {
								if (self.config.api.runtime.lastError) {
									self.errCb(errors.CLAIM_INTERFACE, {
		...
		USBTransaction.prototype.setupEndpoints = function(cb) {
			...
			this.usb.listInterfaces(this.handler, function(ifaces) {
				if (!ifaces) {
					self.errCb(errors.LIST_INTERFACES);
					return
				}
		...
		USBTransaction.prototype.smartOpenDevice = function(device, _nullspeed, _nullmsg, cb) {
			...
			this.config.api.runtime.getManifestAsync(function(manifest) {
				...
				if (!canDetect) {
					self.errCb(errors.DEVICE_DETECTION, {
						device: device,
				...
				self.usb.getDevices(device, function(devs) {
					if (!devs) {
						self.errCb(errors.GET_DEVICES);
						return
					}
					if (devs.length == 0) {
						self.errCb(errors.NO_DEVICE, {
							searchedFor: device
						});
						return
					}
		...
		USBTransaction.prototype.openDevice = function(dev, cb) {
			...
			this.usb.openDevice(dev, function(hndl) {
				...
				if (!hndl) {
					self.errCb(errors.OPEN_USB_DEVICE, {
						device: dev
					});
					return
				}
		...
		USBTransaction.prototype.cmd = function(cmd, cb) {
			if (typeof this.cmdFunction === "undefined") {
				this.errCb(errors.UNDEFINED_COMMAND_PREFIX);
				return
			}
			var self = this,
				info = this.transferIn(this.cmdFunction, cmd[1] << 8 | cmd[0], cmd[3] << 8 | cmd[2], 4);
			this.xferMaybe(info, function(resp) {
				self.log.log("CMD:", hexRep(cmd), hexRep(resp.data));
				cb({
					data: resp.data
				})
			})
		...
		USBTransaction.prototype.errCb = function(err, ctx) {
			...
			if (!this.usb || !this._usedDevice) {
				FiniteStateMachine.prototype.errCb.call(this, err, ctx);
				return
			}
			this.usb.getDevices(this._usedDevice, function(devs) {
				...
				FiniteStateMachine.prototype.errCb.call(self, err, ctx)
			})
		};
		USBTransaction.prototype.localCleanup = function _lc(cb) {
			var self = this;
			this.disconnect(function() {
				self.superCall(_lc, cb)
			})
		};
		...
		USBTransaction.prototype.xfer = function(info, cb) {
			var self = this;
			this.log.log("Performing control transfer", info.direction, hexRep([info.request, info.value, info.index]), "len:", info.length);
			if (info.direction == "out") {
				this.log.log("Data:", hexRep(bufToBin(info.data)))
			}
			this.refreshTimeout();
			scheduler.setImmediate(function() {
				self.transfer(self.handler, info, function(arg) {
					if (!arg || arg.resultCode != 0) {
						self.errCb(errors.TRANSFER_ERROR, {
							response: arg,
							request: info
						});
						return
					}
					arg.data = bufToBin(arg.data);
		...
		(function(global) {
			...
			function mkChecker(expected, check) {
				return function(obj) {
					if (!check(obj)) {
						return {
							error: "Expected " + expected + " got " + obj
						}
					}
					return {
						ok: true
			...
			function isIframeSerializable(obj) {
				if (obj instanceof ArrayBuffer) return true;
				if (isSerializable(obj)) return true;
				if (typeof obj !== "object") return false;
				return Object.getOwnPropertyNames(obj).reduce(function(ret, k) {
					return ret && isIframeSerializable(obj[k])
				}, true)
			}
			...
			var checks = {
				callback: _callback,
				"function": _callback,
				object: mkChecker("object", function(o) {
					return o instanceof Object
				}),
				arraybuffer: mkChecker("arraybuffer", function(o) {
					return o instanceof ArrayBuffer
				}),
				array: mkChecker("array", function(o) {
					return o instanceof Array
				}),
				number: mkChecker("number", function(o) {
					return typeof o === "number"
				}),
				string: mkChecker("string", function(o) {
					return typeof o === "string"
				}),
				bool: mkChecker("string", function(o) {
					return typeof o === "boolean"
				}),
				"boolean": mkChecker("string", function(o) {
					return typeof o === "boolean"
				}),
				json: mkChecker("json", isSerializable),
				iframe: mkChecker("iframe", isIframeSerializable),
				any: function() {
					return {
						ok: true
					}
			...
			function getCheck(checker) {
				...
				if (typeof checker === "function" && checker.prototype) return mkChecker(checker.name || "class", function(obj) {
					return obj instanceof checker
				});
				if (checker instanceof Array) return function(arr) {
					return match(arr, checker)
				};
			...
			function match(args, checkers, index, cb) {
				...
				if (args.length === 0 && checkers.length === 1 && checkers[0] === "varany") return {
					ok: true
				};
				if (args.length === 0 || checkers.length === 0) {
					if (checkers[0] === "varany") return {
						error: "Last args should check with " + checkers.slice(1) + " but couldn't."
					};
					cb && cb(args);
					return {
						error: "Wrong num of arguments: " + (index + args.length) + " (expected " + (index + checkers.length) + ")"
					}
				}
				...
				if (!m.ok) {
					...
					return {
						error: "Argument #" + index + ": " + m.error
					}
				}
				return match(args.slice(1), checkers.slice(1), index + 1, cb)
			}
			var PRODUCTION = typeof global.it !== "function" && typeof global.describe !== "function" && typeof global.process === "undefined";
	...
	55: [function(require, module, exports) {
		(function(global) {
			...
			function shallowCopy(obj) {
				var ret = {};
				if (!obj) return obj;
				if (typeof obj !== "object") throw Error("expected object, not " + typeof obj);
				Object.getOwnPropertyNames(obj).forEach(function(k) {
					ret[k] = obj[k]
				});
				if (obj.__proto__) ret.__proto__ = obj.__proto__;
				return ret
			}
			function replacePrototype(obj, cls1, cls2) {
				if (typeof obj !== "object" || typeof cls1 !== "function" || typeof cls2 !== "function") throw Error();
				if (!obj || !obj.__proto__ || !cls1.prototype || !cls2.prototype) return obj;
				var ret = shallowCopy(obj);
				if (obj !== cls1.prototype) {
					ret.__proto__ = replacePrototype(ret.__proto__, cls1, cls2);
					return ret
				}
				return Object.create(cls2.prototype)
			}
			function forEachWithCallback(arr, cb, endCb) {
				scheduler.setTimeout(function() {
					if (arr.length <= 0) {
						endCb();
						return
					...
					cb(arr[0], function() {
						forEachWithCallback(arr.slice(1), cb, endCb)
					})
				})
			}
			function repeat(times, fn) {
				var ret = new Array(times);
				for (var i = 0; i < times; i++) ret[i] = fn();
				return ret
			}
			function compareVersions(v1, v2, callbacks) {
				function justParse(x) {
					return Number.parseInt(x)
				}
				return compareVersionLists(v1.split(".").map(justParse), v2.split(".").map(justParse), callbacks)
			}
			function compareVersionLists(v1, v2, cbs) {
				if (isNaN(v1[0]) || isNaN(v2[0])) return cbs.err();
				if (v1[0] < v2[0] || v1.length === 0) return cbs.lt();
				if (v1[0] > v2[0] || v2.length === 0) return cbs.gt();
				if (v1.length === 0 && v2.length === 0) return cbs.eq();
				return compareVersionLists(v1.slice(1), v2.slice(1), cbs)
			}
			function getUniqueId(name) {
				global.babelfishUniqueIds = global.babelfishUniqueIds || {};
				global.babelfishUniqueIds[name] = global.babelfishUniqueIds[name] || 1;
				return global.babelfishUniqueIds[name]++
			}
	...
	59: [function(require, module, exports) {
		function isOldstyleGetManifest(message) {
			return message && message.method == "getManifestAsync" && message.object == "runtime" && message.callbackId
		}
				...
				apiRoot.serial.onReceiveError.forceDispatch = function(info) {
					state.connections.forEach(function(c) {
						if (c.apiEvent.methodName == "serial.onReceiveError.addListener") {
							c.apiEvent.methodRequest.getCallback().call(null, info)
						}
					})
				}
			}
	...
	60: [function(require, module, exports) {
		...
		var closingResponses = {
			callingArguments: function(closingRequest) {
				...
				if (this.reverser.path == closingRequest.method && JSON.stringify(closingRequest.args.forSending()) == JSON.stringify(this.methodRequest.args.forSending())) {
					method.apply(null, args);
					this.destroy(true);
			...
			firstResponse: function(closingRequest) {
				...
				if (!closingRequest) {
					var mr = new MethodRequest(null, this.reverser.path, new Arguments([closingArg, function() {}]));
					mr.call(null, this.hostApi);
					return null
				}
				if (JSON.stringify(closingArg) == JSON.stringify(closingRequest.args.forSending()[0]) && closingRequest.method == this.reverser.path) {
					this.destroy(true);
			...
			"default": function(closingRequest) {
				return closingResponses.serial(closingRequest) || closingResponses.firstResponse(closingRequest) || closingResponses.callingArguments(closingRequest)
			}
		};
		...
		function ApiEventEmitter(methodRequest, reverser, hostApi, closeCb) {
			...
			this.maybeRunCloser = function(closingRequest) {
				...
				var closingResponseFactory = closingResponses[self.reverser.type] || closingResponses.
			default,
					ret = closingResponseFactory.call(self, closingRequest);
				if (ret) {
					log.log("Closing[" + self.reverser.type + "]:", ret, "with", closingRequest)
				}
				return ret
			};
	...
	61: [function(require, module, exports) {
		...
		"./arguments/basic.js": 62,
		"./arguments/callback.js": 63,
		"./arguments/container.js": 64,
		"./arguments/data.js": 65,
		"./arguments/databuffer.js": 66,
		"./arguments/factory.js": 67
	}],
	...
	65: [function(require, module, exports) {
		...
		DataArgument.canWrap = function(arg) {
			return arg instanceof Object && DatabufferArgument.canWrap(arg.data)
		};
	...
	66: [function(require, module, exports) {
		...
		DatabufferArgument.prototype = {
			...
			forSending: function() {
				return this.obj || {
					data: util.bufToArr(this.buffer),
					isArrayBuffer: true
				}
			},
			concat: function(msg) {
		...
		(function(global) {
			...
			BootStrapClient.prototype = {
				...
				getHostId: function(cb, cfg) {
					cfg = cfg || {};
					var appIds = cfg.ids || global.appIds || ["jommgdhcpkjoikkjcnpafeofedlfphfb", "magknjdfniglanojbpadmpjlglepnlko", global.APP_ID],
						car = appIds[0],
						cdr = appIds.slice(1),
						self = this;
					if (!car) {
		...
		(function(global) {
			...
			Log.prototype = {
				timestampString: function() {
					var now = new Date(new Date - timeOffset + timeOffset.getTimezoneOffset() * 6e4);
					var pad = function(n) {
							if (n < 10) {
								return "0" + n
							}
					...
					if (this.showTimes) {
						return function() {
							if (self.verbosity > verbosity || global.debugBabelfish) {
								return console[type].apply(console, [self.prefix()].concat(arguments))
							}
						}
					}
				...
				prefix: function() {
					if (this.showTimes) return "[" + this.timestampString() + " : " + this.name + "]";
					return "[" + this.name + "] "
				}
			};
	...
	77: [function(require, module, exports) {
		...
		"./messaging/chrome.js": 78,
		"./messaging/dummy.js": 79
	}],
	78: [function(require, module, exports) {
		function ChromeMessaging() {
			this.version = chrome.runtime.getManifest ? chrome.runtime.getManifest().version : "1";
	...
	79: [function(require, module, exports) {
		(function(global) {
			...
			Event.prototype = {
				...
				removeListener: function(cb) {
					dbg("Removing listner: " + cb.id + " from " + this.name + " (" + this.listeners.map(function(l) {
						return l.id
					}) + " - " + this.removed + " )");
					this.listeners = this.listeners.filter(function(l) {
						var same = cb === l,
				...
				trigger: function(varArgs) {
					...
					dbg("Triggering[" + this.listeners.length + "]: " + this.name + "|" + (args[0] instanceof Port ? "<port>" : JSON.stringify(args)));
	...
	80: [function(require, module, exports) {
		...
		"./requests/burst.js": 81,
		"./requests/generic.js": 82,
		"./requests/method.js": 83
	}],
		...
		GenericRequest.prototype = {
			...
			send: function(cb, errorCb) {
				...
				messageApi.sendMessage(hostId, msg, function(resp) {
					genericRespHandler(resp, self, cb ||
					function(err) {
						if (err) {
							throw err
						}
	...
	83: [function(require, module, exports) {
		...
		function handleReverser(msg, connections, hostApi) {
			...
			var req = MethodRequest.fromMessage(null, msg),
				response = connections.map(function(c) {
					return c.tryClosing(req)
				}).reduce(function(a, b) {
					return a || b
				}, false);
			if (msg.isReverser && !response) {
				console.warn("You told me " + JSON.stringify(msg) + " was a reverser but i found nothing to reverse.");
				if (msg.noCallback) {
					req.call(null, hostApi);
					return new ErrResponse("Tried to clean with " + msg.method + " but failed.", "warning")
				}
		...
		MethodRequest.maybeHandle = function(msg, hostApi, sendRespRaw, kw) {
			...
			sendRespRaw = sendRespRaw ||
			function() {};
			var sendArgsAsResponse = function(varArgs) {
					var argsArr = [].slice.call(arguments),
						cbArgs = new Arguments(argsArr),
						argsResp = new ArgsResponse(cbArgs);
					if (chrome && chrome.runtime && chrome.runtime.lastError && argsArr.length == 0) {
						new ErrResponse(chrome.runtime.lastError, "chrome.runtime.lastError").send(_sendRespRaw);
						return true
					}
			...
			try {
				...
				resp = new ErrResponse({
					message: "Error on calling " + msg.method + ":" + e.message,
					stack: e.stack
		...
		MethodRequest.prototype.call = function(sendResp, hostApi) {
			...
			MethodRequest.maybeHandle(this.forSending(), hostApi, sendResp || this.getCallback(), {
		...
		MethodRequest.prototype.realCallback = function() {
			var self = this,
				callback = self.args.getCallback();
			return function() {
	...
	84: [function(require, module, exports) {
		...
		"./responses/ack.js": 85,
		"./responses/arguments.js": 86,
		"./responses/burst.js": 87,
		"./responses/error.js": 88,
		"./responses/generic.js": 89
	}],
			...
			function maybeConcatData(msgs) {
				...
				return Object.getOwnPropertyNames(dataSources).map(function(k) {
					...
					if (concatArg instanceof DataArgument) {
						return new ArgsResponse(new Arguments([concatArg.forSending()])).forSending()
					}
					return concatArg
				})
			}
			if (0) {
				servedBurstMetrics.push({
					time: Date.now(),
					length: msg.cbArgsArr.length
				});
				var totalRequests = servedBurstMetrics.reduce(function(sum, m) {
					return sum + m.length
				}, 0);
				log.log("Burst summary:", {
					requestPerSec: totalRequests * 1e3 / (Date.now() - servedBurstMetrics[0].time),
	...
	89: [function(require, module, exports) {
		...
		function genericRespHandler(msg, request, done) {
			...
			var responseTypesArr = [require("./error.js"), require("./burst.js"), require("./arguments.js"), require("./ack.js")];
	...
	90: [function(require, module, exports) {
		...
		function getKeepAliveConnection(hostId, connectCb, disconnectCb, timeout) {
			messageApi = require("./messaging.js");
			var portName = JSON.stringify({
				type: "KeepAliveConnection"
			}),
				port = messageApi.connect(hostId, {
					name: portName
				});
			if (disconnectCb) {
			...
			port.onMessage.addListener(function tokenizer(msg) {
				...
				if (msg && msg.version && msg.version.split(".")[0] != messageApi.version.split(".")[0]) {
		...
		function HostServer(apiRoot) {
			...
			function messageHandle(message, sender, sendResp) {
				return MethodRequest.maybeHandle(message, apiRoot, sendResp, {
					connections: state.connections
				}) || BurstRequest.maybeHandle(message, state.connections, sendResp) || new ErrResponse("Nothing to do for message." + JSON.stringify(message), false).send(sendResp)
			}
		...
		(function(global) {
			...
			if (!(global.postMessage && global.addEventListener) || isApp()) {
				...
				(function() {
					...
					function post(fn) {
						if (i === 4294967296) i = 0;
						if (++i in timeouts) throw new Error("setImmediate queue overflow.");
						timeouts[i] = fn;
						global.postMessage({
							type: messageName,
							id: i
	...
	93: [function(require, module, exports) {
		module.exports.NpapiChrome = require("./src/chrome.js").Chrome
	}, {
		"./src/chrome.js": 95
	}],
	94: [function(require, module, exports) {
		...
		function AsyncNpapi(obj, isAlive) {
			...
			this.queue = [];
			obj.setErrorCallback(function(err) {
			...
			Object.getOwnPropertyNames(this.npapi).forEach(function(n) {
				...
				function __action(cb, args) {
					if (self.jsLevelClosed) {
						self.log.warn("Calling on closed:", n, args);
						self.onError.dispatch("device-lost");
						cb();
						return
					}
					if (!self.npapi[n]) {
						self.log.error("Method ", n, "does not exist (", args, ")");
						self.onError.dispatch("plugin-died");
						return
					}
					var ret, date = Date.now();
					try {
						ret = self.npapi[n].apply(self.npapi, args)
					} catch (e) {
						...
						self.log.log("Called:", n, "(", args, ") Failed:", e, "time:", Date.now() - date);
						return
					}
					self.log.log("Called:", n, "(", args, ") =>", ret, "time:", Date.now() - date);
					cb(ret)
				}
				self[n] = function() {
					var args = [].slice.call(arguments),
					...
					function __notifyingCb() {
						self.queue.shift();
						self.queue[0] && scheduler.setTimeout(self.queue[0]);
						return cb.apply(null, arguments)
					}
					self.queue.push(__action.bind(null, __notifyingCb, args));
					if (self.queue.length === 1) self.queue[0]()
				}
			})
		}
		AsyncNpapi.prototype = {
			jsLevelClose: function() {
				this.jsLevelClosed = true;
				this.onError.close()
			},
			isBusy: function() {
	...
	95: [function(require, module, exports) {
		var Serial = require("./serial.js").Serial,
			Runtime = require("./runtime.js").Runtime;

		function Chrome(npapi) {
			this.runtime = new Runtime(npapi, this);
			this.serial = new Serial(npapi, this);
			this.local = {
				clientId: "we-are-on-firefox"
			}
		}
	...
	96: [function(require, module, exports) {
		var AsyncNpapi = require("./asyncify.js").AsyncNpapi,
			Event = require("corelib").Event,
			scheduler = require("corelib").scheduler,
		...
		function defaultConnectionInfo(cid, name, serial) {
			checkargs(arguments, ["number", "string", "object"]);
			return {
				connectionId: cid,
				paused: false,
				persistent: false,
				...
				receiveTimeout: -1,
				sendTimeout: -1,
				bitrate: Number(serial.getBaudrate()),
				dataBits: function(b) {
					switch (b) {
					case 8:
						return "eight";
					...
					case 7:
						...
						break;
					default:
						throw Error("Unexpected byteSize: " + b + "(" + typeof b + ")")
					}
				}(Number(serial.getBytesize())),
				parityBit: function(p) {
					switch (p) {
					case 0:
						return "no";
						break;
					...
					case 2:
						...
						break;
					default:
						throw Error("Unexpected parity: " + p + "(" + typeof p + ")")
					}
				}(Number(serial.getParity())),
				stopBits: function(s) {
					switch (s) {
					case 1:
						return "one";
					...
					case 2:
						...
						break;
					default:
						throw Error("Unexpected stopbuts: " + s + "(" + typeof s + ")")
					}
				}(Number(serial.getStopbits())),
				ctsFlowControl: !! Number(serial.getFlowcontrol()),
				_serial: serial
			}
		}
		function bufsize(lastPackLen) {
			if (lastPackLen < 50) return 100;
			if (lastPackLen > 1e4) return 2e4;
			return lastPackLen * 2
		}
		function systemPath(path) {
			var winPrefix = "\\\\.\\",
				com = "COM";
			if (path.slice(0, com.length) === com) return winPrefix + path;
			return path
		}
		function userPath(path) {
			var winPrefix = "\\\\.\\",
				com = "COM";
			if (path.slice(0, winPrefix.length + com.length) === winPrefix + com) return path.slice(winPrefix.length);
			return path
		}
		function Connection(path, connectionId, options, npapi) {
			checkargs(arguments, ["string", "number", "object", "object"]);
		...
		Connection.prototype = {
			mkSerial: function() {
				...
				var self = this,
					syncSerial = new this.npapi.Serial(systemPath(this.path), makeSerialProps(this.options));
				if (!syncSerial || syncSerial.error) {
					scheduler.setTimeout(function() {
						self.onError.dispatch(syncSerial.error)
					});
					return false
				}
				this.serial = new AsyncNpapi(syncSerial, function(npapi) {
					return npapi && npapi.getPort && userPath(npapi.getPort()) === userPath(this.path)
				});
			...
			handleError: function(err) {
				...
				if (err && err.exception) {
					this.handleNpapiException(err.exception);
					return
				}
				console.error("Unknown error:", err)
			},
			handleNpapiException: function() {
				var self = this,
					exists = JSON.parse(this.npapi.getPorts()).some(function(p) {
						return userPath(p.port) === userPath(self.path)
					});
				this.onError.dispatch(!exists ? "device_lost" : "system_error")
			},
			readBytes: function(done) {
				var self = this;
				if (this.closed) return;
				this.serial.isOpen(function(isOpen) {
					if (!isOpen) return;
					self.serial.readBytes(1024, function(ret) {
						if (ret instanceof Array) {
							done(ret);
							return
						}
						self.log.warn("Unexpected return from readBytes:", ret);
						scheduler.setTimeout(self.onError.dispatch.bind(self.onError, "system_error"))
					});
					return
				})
			},
			safeOpen: function(cb) {
				var self = this;
				checkargs(arguments, ["callback"]);
				if (!this.mkSerial()) return;
				this.serial.isOpen(function(isOpen) {
					if (isOpen) {
					...
					self.serial.open(function() {
						self.serial.isOpen(cb)
					})
				})
			},
		...
		function createConnection(path, connectionId, options, npapi, callback) {
			var con = new Connection(path, connectionId, options, npapi);
			con.safeOpen(function(ok) {
				if (!ok) {
					callback();
					return
				}
		...
		module.exports.defaultConnectionInfo = defaultConnectionInfo;
	...
	97: [function(require, module, exports) {
		...
		function bytesPacket(connectionId, bytes) {
			return {
				connectionId: connectionId,
				data: binToBuf(bytes)
			}
		}
		function pipeBytes(done, connections, listeners) {
			if (!connections || !listeners || connections.length === 0 || listeners.length === 0) return;
			pipeBytes_(done, connections, listeners)
		}
		function pipeBytes_(done, connections, listeners) {
			if (connections.length === 0) {
				done();
				return
			}
			connections[0].readBytes(function(bytes) {
				if (bytes.length !== 0) listeners.forEach(function(l) {
					l(bytesPacket(connections[0].connectionId, bytes))
				});
				pipeBytes_(done, connections.slice(1), listeners)
			})
		}
		function zipEvents(fn, ev1, ev2, etc) {
			var events = [].slice.call(arguments, 1),
				state = new Array(events.length);

			function maybeDispatch(evIndex, val) {
				state[evIndex] = val;
				fn.apply(null, state)
			}
			events.forEach(function(ev, index) {
				events[index].addListener(maybeDispatch.bind(null, index))
			})
		}
		function delayedEvent(ms) {
			var ret = new Event;
			ret.dispatch = function(oldDispatch) {
				var args = [].slice.call(arguments, 1);
				scheduler.setTimeout(function() {
					oldDispatch.apply(null, args)
				}, ms)
			}.bind(ret, ret.dispatch.bind(ret));
			return ret
		}
		function OnReceive() {
			this.onListenersUpdate = new Event;
			this.onConnectionsUpdate = new Event;
			this.onRead = delayedEvent(50);
			this.listeners = [];
			var _pipeBytes = pipeBytes.bind(null, this.onRead.dispatch.bind(this.onRead));
			zipEvents(_pipeBytes, this.onConnectionsUpdate, this.onListenersUpdate, this.onRead);
			var cl = function(msgs) {
					var args = arguments;
					return function() {
			...
			this.onListenersUpdate.addListener(cl("Listeners update"))
		}
		OnReceive.prototype = {
			addListener: function(l) {
				this.listeners.push(l);
				this.onListenersUpdate.dispatch(this.listeners)
			},
			removeListener: function(l) {
				this.listeners = this.listeners.filter(neq.bind(null, l));
				this.onListenersUpdate.dispatch(this.listeners)
			},
			hasListener: function(l) {
				return this.listeners.some(eq.bind(null, l))
			},
			close: function() {
				this.onRead.close();
	...
	98: [function(require, module, exports) {
		function createLastError(val) {
			return {
				read: false,
				value: val
			}
		}
		function Runtime(npapi, chrome) {
			this._lastError = createLastError(null);
			this.npapi = npapi;
			Object.defineProperty(this, "lastError", {
				get: function() {
					if (this._lastError) {
						this._lastError.read = true
					}
		...
		Runtime.prototype = {
			...
			withLastErrorCb: function(lastError, cb) {
				var self = this;
				return function() {
					var oldLastError = self._lastError;
					self._lastError = createLastError(lastError);
					cb();
					if (!self._lastError.read) {
						console.error("chrome.runtime.lastError MUST be checked:", self._lastError.value)
					}
					self._lastError = oldLastError
				}
			},
			getManifestAsync: function(cb) {
				cb({
					version: this.npapi.version
				})
			},
			getPlatformInfo: function(cb) {
				cb(this.platformInfo)
			},
			setPlatformInfo: function(info, cb) {
	...
	99: [function(require, module, exports) {
		...
		function notimplemented(method) {
			throw Error("Sorry, " + method + " not implemented.")
		}
		function async(cb, _args) {
			var args = [].slice.call(arguments, 1);
			scheduler.setTimeout(function() {
				cb.apply(null, args)
			})
		}
		function Serial(npapi, chrome) {
			var self = this;
			...
			var connectionMethods = ["setControlSignals", "getControlSignals", "setBreak", "clearBreak", "flush", "send", "getConnection", "update", "setPaused", "getInfo"];
			connectionMethods.forEach(function(m) {
				self[m] = self._wrappedConnectionMethod(m)
			})
		}
		Serial.prototype = {
			close: function() {
				var self = this;
				Object.getOwnPropertyNames(this.connections).forEach(function(c) {
					var con = self.connections[c];
					con.close()
				});
				this.onReceive.close();
				this.onReceiveError.close()
			},
			_connectionsLength: function() {
				return Object.getOwnPropertyNames(this.connections).length
			},
			_forConnections: function(cb, endCb, connections) {
				var self = this,
					_connections = connections || Object.getOwnPropertyNames(this.connections).map(function(c) {
						return self.connections[c]
					}),
					next = function() {
						self._forConnections(cb, endCb, _connections.slice(1))
					};
				async(function() {
					...
					var con = self.connections[_connections[0].connectionId];
					if (!con) {
						next();
						return
					}
					...
					cb(_connections[0], next)
				})
			},
			_doSetBreak: function(connection, val, callback) {
				connection.serial.setBreak(val, function() {
					callback(true)
				})
			},
			_deleteConnection: function(connectionId) {
				var c = this.connections[connectionId];
				if (!(c && c instanceof Connection)) {
					this.log.error("Deleting nonexistent id:", connectionId, this.connections);
					return
				}
				c.close();
				this.connections[connectionId] = null;
				delete this.connections[connectionId];
				this.dispatchConnectionsUpdate()
			},
			dispatchConnectionsUpdate: function() {
				var cnx = this.connections,
					self = this;
				scheduler.setTimeout(function() {
					self.onReceive.onConnectionsUpdate.dispatch(Object.getOwnPropertyNames(cnx).map(function(k) {
						return cnx[k]
					}))
				})
			},
			_getConnection: function(connectionId, noLastError, callback) {
				var connection = this.connections[connectionId],
					self = this;

				function fail(msg, firstTimeLost) {
					self._deleteConnection(connectionId);
					if (firstTimeLost) self.onReceiveError.dispatch({
						connectionId: connectionId,
						error: "device-lost"
					});
					if (noLastError) {
					...
					self.chrome.runtime.withLastErrorCb(msg, callback)()
				}
				if (!connection || connection.closed) {
					fail("No such connection.", false);
					return
				}
				connection.serial.isOpen(function(ok) {
					if (!ok) {
						fail("Connection was lost.", true);
						return
					}
					callback(connection)
				})
			},
			_wrappedConnectionMethod: function(method) {
				return function() {
					var args = [].slice.call(arguments),
					...
					this._getConnection(connectionId, false, function(c) {
						if (!c) {
							callback();
							return
						}
						self.__proto__[method].apply(self, [c].concat(args.slice(1)))
					})
				}
			},
			handleErrors: function(connectionId, error) {
				this.log.warn("Dispatching error(", connectionId, "):", error);
			...
			getDevices: function(cb) {
				...
				var self = this,
					...
					normalDevs = devs.map(function(d) {
						return {
							path: userPath(d.port)
						}
					});
				Object.getOwnPropertyNames(this.connections).forEach(function(cid) {
					var con = self.connections[cid],
						portExists = normalDevs.some(function(dev) {
							return !con.closed && dev.path === userPath(con.path)
						});
					if (portExists) return;
					self._deleteConnection(cid);
					self.onReceiveError.dispatch({
						connectionId: cid,
						error: "device_lost"
					})
				});
			...
			connect: function(path, options, callback) {
				checkargs(arguments, ["string", "object", "callback"], callback);
				this.log.log("Connecting:", path, options);
				var self = this;
				createConnection(path, ++self.connectionId, options, this.npapi, function(connection) {
					if (!connection) {
						this.runtime.withLastErrorCb("Failed to open device", callback);
						return
					}
					self.connections[self.connectionId] = connection;
			...
			disconnect: function(connectionId, callback) {
				checkargs(arguments, ["number", "callback"], callback);
				var connection = this.connections[connectionId],
					self = this;
				this.log.log("Disconnecting:", connectionId, this.connections);
				if (!connection) {
					this.log.warn("No connection for:" + connectionId);
					this.log.warn("Connections:", this.connections);
					async(callback, false);
					return
				}
				connection.close(function(ok) {
					ok && self._deleteConnection(connectionId, "lost");
					callback(ok)
				})
			},
			update: function(connectionId, options, callback) {
				checkargs(arguments, ["number", "object", "callback"], callback)
			},
			setPaused: function(connectionId, paused, callback) {
				notimplemented("setPaused")
			},
			getInfo: function(connectionInfo, callback) {
				callback(connectionInfo)
			},
			getConnections: function(callback) {
				checkargs(arguments, ["callback"], callback);
				var self = this,
					ret = [];
				this._forConnections(function(con, done) {
					con.serial.isOpen(function(ok) {
						if (ok) {
							ret.push(con.info || con);
							done();
							return
						}
						self.onReceiveError.dispatch({
							connectionId: con.conectionId,
							error: "device_lost"
						});
			...
			send: function(connectionInfo, data, callback) {
				checkargs(arguments, ["any", "arraybuffer", "callback"], callback);
				this.log.log("sending on:", connectionInfo.connectionId);
				var arrData = bufToBin(data),
					ser = connectionInfo.serial;
				ser.writeArray(arrData, function(writtenBytes) {
					callback({
						bytesSent: Number(writtenBytes)
					})
				})
			},
			flush: function(connectionInfo, callback) {
				checkargs(arguments, ["any", "callback"], callback);
				var ser = connectionInfo.serial;
				this.log.log("flushing on:", connectionInfo.connectionId);
				ser.flush(function() {
					callback(true)
				})
			},
			getControlSignals: function(connectionInfo, callback) {
				checkargs(arguments, ["any", "callback"], callback);
				var ser = connectionInfo.serial;
				ser.getCTS(function(cts) {
					ser.getDSR(function(dsr) {
						ser.getRI(function(ri) {
							ser.getCD(function(cd) {
								callback({
									cts: !! Number(cts),
									dsr: !! Number(dsr),
									cd: !! Number(cd),
			...
			setControlSignals: function(connectionInfo, signals, callback) {
				checkargs(arguments, ["any", "object", "callback"], callback);
				var ser = connectionInfo.serial;
				ser.setDtrRts( !! signals.dtr, !! signals.rts, callback.bind(null, true));
				if (0) {
					var noop = function(cb) {
						...
						setRts = noop,
						setDtr = noop;
					if (typeof signals.rts !== "undefined") setRts = function(cb) {
						ser.setRTS(signals.rts, cb)
					};
					if (typeof signals.dtr !== "undefined") setDtr = function(cb) {
						ser.setDTR(signals.dtr, cb)
					};
					setRts(function() {
						setDtr(function() {
							callback(true)
			...
			setBreak: function(connection, callback) {
				checkargs(arguments, ["any", "callback"], callback);
				this._doSetBreak(connection, true, callback)
			},
			clearBreak: function(connection, callback) {
				checkargs(arguments, ["any", "callback"], callback);
	...
	100: [function(require, module, exports) {
		var checkargs = require("corelib").typecheck;

		function defaultTimeout(baudrate) {
			var constDivider = baudrate / 9 / 100 || 1,
				readTimeout = 1e3 / constDivider;
			return {
				inter_byte_timeout: 10,
				read_timeout_constant: readTimeout,
				read_timeout_multiplier: 0,
				write_timeout_constant: 0,
				write_timeout_multiplier: 10
			}
		}
		function doDataBits(tracker, connection, ret) {
			delete tracker.dataBits;
			if (typeof connection.dataBits !== "undefined") {
				if (typeof connection.dataBits !== "number") {
					throw Error("Expected dataBits to be number but it's " + connection.dataBits)
				}
		...
		function doParity(tracker, connection, ret) {
			delete tracker.parity;
			if (typeof connection.parity !== "undefined") {
		...
		function doBitrate(tracker, connection, ret) {
			delete tracker.bitrate;
			if (typeof connection.bitrate !== "undefined") {
				if (typeof connection.bitrate !== "number") {
					throw Error("Expected bitrate to be number but it's " + connection.bitrate)
				}
				ret.baudrate = connection.bitrate
			}
		}
		function doTimeout(tracker, connection, ret) {
			ret.timeout = defaultTimeout(connection.bitrate);
			delete tracker.sendTimeout;
			if (connection.sendTimeout) ret.timeout.write_timeout_constant = connection.sendTimeout;
			delete tracker.receiveTimeout;
			if (connection.receiveTimeout) ret.timeout.read_timeout_constant = connection.receiveTimeout
		}
		function doName(tracker, connection, ret) {
			delete tracker.name;
			if (typeof connection.name !== "undefined") {
				if (typeof connection.name !== "string") throw Error("Bad name value (expected string): " + connection.name)
			}
		}
		function doStopBits(tracker, connection, ret) {
			delete tracker.stopBits;
			if (typeof connection.parity !== "undefined") {
				switch (connection.stopBits) {
				case "one":
					ret.stopbits = 1;
					break;
				case "two":
		...
		function doCtsFlowControl(tracker, connection, ret) {
			delete tracker.ctsFlowControl;
			if (typeof connection.ctsFlowControl !== "undefined") ret.flowcontrol = !! connection.ctsFlowControl
		}
		function makeSerialProps(connection) {
			var ret = {},
				propertyTracker = {},
				leftovers = [];
			checkargs([connection.bitrate], ["number"]);
			Object.getOwnPropertyNames(connection).forEach(function(k) {
				propertyTracker[k] = connection[k]
			});
			...
			leftovers = Object.getOwnPropertyNames(propertyTracker);
			if (leftovers.length > 0) {
				throw Error("Unsupported connection args: " + leftovers)
			}
			return ret
		}
		module.exports.makeSerialProps = makeSerialProps
	...
	101: [function(require, module, exports) {
		module.exports.backends = require("./lib/backends.js").backends;
		...
		module.exports.provideAvailabilityToPage = require("./lib/iframeavailability.js").provideAvailabilityToPage
	}, {
		"./lib/appavailability.js": 102,
		"./lib/backends.js": 104,
		"./lib/codebenderavailability.js": 105,
		"./lib/iframeavailability.js": 113,
		"./lib/npapiavailability.js": 114,
		"./lib/pollavailability.js": 116
	}],
	102: [function(require, module, exports) {
		(function(global) {
			var backends = require("./backends.js").backends,
			...
			function canHaveIds(appIds, done) {
				if (appIds.length === 0) {
					done(false);
					return
				}
				if (!global.chrome || !global.chrome.runtime || !global.chrome.runtime.connect) {
					done(false);
					return
				}
				var p = global.chrome.runtime.connect(appIds[0], {
					name: "error-causer"
				});
				if (!p || !p.onDisconnect || !p.onDisconnect.addListener || !p.postMessage || !p.disconnect) {
					canHaveIds(appIds.slice(1), done);
					return
				}
				var to = scheduler.setTimeout(function() {
					to = null;
					p.disconnect();
					done(true)
				}, 1e3);
			...
			function AppAvailable() {
				Available.call(this);
				this.setupClient = backends.app().client.setupClient
			}
			AppAvailable.prototype = Object.create(Available.prototype);
			AppAvailable.prototype.canHave = function(done) {
				canHaveIds(["magknjdfniglanojbpadmpjlglepnlko", "jommgdhcpkjoikkjcnpafeofedlfphfb"], done)
			};
			AppAvailable.prototype.connectionId = function() {
				return this.api && this.api.local && typeof this.api.local.clientId === "number" ? this.api.local.clientId : null
			};
			AppAvailable.prototype.isConnected = function() {
				return this.api && this.api.local && this.api.local.token
			};
			AppAvailable.prototype.checkVersion = function(callback) {
				var self = this;
				Available.prototype.checkVersion.call(this, function(ok) {
					if (!self.api || !ok) {
						callback(false);
						return
					}
					self.api.runtime.getManifestAsync(function(man) {
						if (!man) {
							callback(false);
							return
						}
						...
						compareVersions(man.version, "1.0.0.8", {
							lt: f,
							eq: s,
							gt: s,
							err: f
			...
			AppAvailable.prototype.connect = function(timeout) {
				var self = this;
				this.api = this.api || {};
				this.setupClient(this.api, function() {
					...
					self.onError.dispatch(errors.APP_ERROR.copy({
						error: err
					}))
				}, timeout)
			};
			AppAvailable.prototype.disconnect = function(done, dispatchEvents) {
			...
			module.exports.AppAvailable = AppAvailable
		}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
	}, {
		"./availability.js": 103,
		"./backends.js": 104,
	...
	103: [function(require, module, exports) {
		...
		Available.prototype = {
			connectionId: function() {
				return this.isConnected() ? this.uniqueId : null
			},
			init: function(cb, timeout) {
				if (cb && !this.onFound.hasListener(cb)) {
					this.onFound.removeListener(this.initCb);
					this.initCb = cb;
					this.onFound.addListener(this.initCb)
				}
				if (this.isConnected()) {
			...
			shutdown: function(done, dispatchEvents) {
				var self = this;
				this.disconnect(function() {
			...
			withInited: function(callback) {
				...
				function cleanup() {
					self.onError.removeListener(fail_);
					self.onLost.removeListener(fail_);
					if (self.initCb === initFn) {
						self.onFound.removeListener(self.initCb);
						self.initCb = null
					}
				}
				function initFn() {
				...
				this.onLost.addListener(fail_)
			},
			canHave: function(callback) {
				callback(true)
			},
			checkVersion: function(callback) {
				var self = this;
				this.withInited(function(ok) {
					callback(ok)
				})
			}
		};
	...
	104: [function(require, module, exports) {
		module.exports.backends = {
			app: function() {
				return require("./../backends/chrome-app")
			},
			npapi: function() {
				return require("./../backends/npapi-plugin")
			}
		}
	}, {
		"./../backends/chrome-app": 57,
		"./../backends/npapi-plugin": 93
	}],
	105: [function(require, module, exports) {
		var Available = require("./availability.js").Available,
		...
		function tryAvailables(availables, done) {
			if (availables.length === 0) {
				done(null);
				return
			}
			scheduler.setTimeout(function() {
				availables[0].canHave(function(canHave) {
					if (canHave) {
						done(availables[0]);
						return
					}
					tryAvailables(availables.slice(1), done)
				})
			})
		}
		function CodebenderAvailable() {
			this.wrappedAvailable = null;
		...
		CodebenderAvailable.prototype = Object.create(Available.prototype);
		CodebenderAvailable.prototype.mk = function(cls) {
			var availobj = Object.create(cls.prototype);
			cls.apply(availobj, this.buildargs);
			return availobj
		};
		CodebenderAvailable.prototype.delegateToWrapped = function(failCb, method) {
			var args = [].slice.call(arguments, 2),
				self = this;
			if (this.wrappedAvailable) {
				this.wrappedAvailable[method].apply(this.wrappedAvailable, args);
				return
			}
			platform.getAvailability(this.buildargs[0], function(avail) {
				if (!avail) {
					scheduler.setTimeout(self.noAvailableAvailable.bind(self));
					return
				}
				self.wrapAvailable(avail);
				self[method].apply(self, args)
			}, failCb)
		};
		CodebenderAvailable.prototype.checkVersion = function(cb) {
			this.delegateToWrapped(function(message) {
				cb(false)
			}, "checkVersion", cb)
		};
		CodebenderAvailable.prototype.canHave = function(cb) {
			this.delegateToWrapped(function(message) {
				cb(false)
			}, "canHave", cb)
		};
		CodebenderAvailable.prototype.connect = function(timeout) {
			var self = this;
			this.delegateToWrapped(function(userMessage) {
				self.onError.dispatch(errors.BAD_PLATFORM.copy({
					userMessage: userMessage,
					allErrors: arguments[1]
				}))
			}, "connect", timeout)
		};
		CodebenderAvailable.prototype.noAvailableAvailable = function() {
			this.onError.dispatch(errors.ELUSIVE_PLATFORM.copy())
		};
		CodebenderAvailable.prototype.wrapAvailable = function(available) {
			delete this.state;
			this.__proto__ = available;
			var self = this;
			["init", "connect", "disconnect", "destroy", "isConnected", "canHave", "checkVersion"].forEach(function(m) {
				self[m] = function() {
					var _this = this === self ? available : this;
					available[m].apply(_this, arguments)
				}
			});
			["onError", "onLost", "onFound"].forEach(function(ev) {
				available[ev].listeners = available[ev].listeners.concat(self[ev].listeners);
				available[ev].dispatcher = self[ev].dispatcher;
				self[ev] = available[ev]
			})
		};
		module.exports.CodebenderAvailable = CodebenderAvailable
	}, {
		"./appavailability.js": 102,
		"./availability.js": 103,
		"./errors.js": 106,
		"./iframeavailability.js": 113,
		"./npapiavailability.js": 114,
		"./platformcheck.js": 115,
		corelib: 118
	}],
	106: [function(require, module, exports) {
		...
		module.exports = errno({
			...
			BAD_PLATFORM: new RetVal(3, "Unsupported platform."),
			ELUSIVE_PLATFORM: new RetVal(4, "Undeterminable platform."),
			IFRAME_CONNECTION: new RetVal(5, "Failed to connect to iframe."),
			ILLEGAL_IFRAME_STATE: new RetVal(6, "Illegal connection state."),
			LOST_DURING_IFRAME_INIT: new RetVal(7, "The iframe was lost while we were initializing")
		})
	}, {
		corelib: 118
	}],
	107: [function(require, module, exports) {
		...
		CallbackRepo.prototype = {
			silence: function(id) {
				this.fns[id] = util.noop
			},
			push: function(fn) {
			...
			get: function(id) {
				...
				var fn = this.fns[id];
				if (!fn) {
					console.log("Get failed(" + this.id + "): " + id);
					return null
				}
				return fn
			},
			...
			pop: function(id, args) {
				this.extract(id).apply(null, [].slice.call(arguments, 1))
			},
			peek: function(id, args) {
				typecheck(arguments, ["number", "varany"]);
				var fn = this.get(id);
				if (fn) return fn.apply(null, [].slice.call(arguments, 1));
				console.warn("Missing callback", id, args);
				console.warn("Available callbacks:", this.fns);
				return null
			}
		};
		module.exports.CallbackRepo = CallbackRepo
	}, {
		"./common.js": 108,
		corelib: 118
	}],
	108: [function(require, module, exports) {
		...
		function path2Obj(obj, path) {
			typecheck(arguments, ["object", "array"]);
			if (path.length === 0) return obj;
			if (!obj[path[0]]) return null;
			return path2Obj(obj[path[0]], path.slice(1))
		}
		function path2Method(obj, path) {
			var host = path2Obj(obj, path.slice(0, -1)),
				fn = path2Obj(obj, path);
			if (!fn) throw Error("No " + path + " in " + obj.toString());
			return fn.bind(host)
		}
		function pathSetObject(root, val, path) {
			if (path.length <= 1) {
				root[path[0]] = val;
				return
			}
			if (!root[path[0]]) root[path[0]] = {};
			pathSetObject(root[path[0]], val, path.slice(1))
		}
		function pathListToDict(list) {
			var ret = {};
		...
		function prefixObjectKeys(prefix, apiConf) {
			var ret = {};
			Object.getOwnPropertyNames(apiConf).forEach(function(key) {
				ret[prefix + key] = apiConf[key]
			});
			return ret
		}
		module.exports.prefixObjectKeys = prefixObjectKeys;
	...
	109: [function(require, module, exports) {
		...
		function mkEvent(syncobj, path) {
			typecheck(arguments, [SyncedObject, "array"]);
			var listeners = {},
				ids = {},
				uid = 0,
			...
			function unlisten(cb) {
				...
				var id = null;
				Object.getOwnPropertyNames(listeners).some(function(key) {
					if (listeners[key] !== cb) return false;
					id = key;
					return true
				});
				if (!id) return;
			...
			function haslistener(cb) {
				...
				return Object.getOwnPropertyNames(listeners).some(function(key) {
					return listeners[key] === cb && !! ids[key]
				})
			}
			function listen(cb) {
				typecheck(arguments, ["function"]);
				if (typeof cb !== "function") return;
				if (haslistener(cb)) return;
				var id = uid++;
				listeners[id] = cb;
				syncobj.remoteListenCb(listenPath, [], cb, function(lid, rid) {
					if (listeners[id] === cb) {
						ids[id] = {
							lid: lid,
							rid: rid
					...
					syncobj.remoteUnlistenCb(unlistenPath, [], util.noop, lid, rid)
				})
			}
			function dispatch(varArgs) {
				syncobj.remote(path.concat(["forceDispatch"]), [].slice.call(arguments))
			}
			return {
		...
		function mkAsync(argNumber, target, syncobj, path) {
			typecheck(arguments, ["number", "object", SyncedObject, "array"]);
			return function() {
				var args = [].slice.call(arguments, 0, argNumber - 1),
					cb = arguments[argNumber - 1];
				syncobj.remoteAsyncCb(path, args, cb)
			}
		}
		function fnAsAsync(target, syncobj, path) {
			typecheck(arguments, ["object", SyncedObject, "array"]);
			return {
				async: function() {
					var args = [].slice.call(arguments),
						cb = args.pop();
					return syncobj.remoteRetCb(path, args, cb)
				}
			}
		}
		function valueAsAsync(target, syncobj, path) {
			typecheck(arguments, ["object", SyncedObject, "array"]);
			return {
				get: function(cb) {
					typecheck(arguments, ["callback"]);
					return syncobj.rgetProperty(path, cb)
				}
			}
		}
		function async(types) {
			typecheck(arguments, ["array"]);
			return function(target, syncobj, path) {
				typecheck(arguments, ["object", SyncedObject, "array"]);
				var _async = mkAsync(types.length, target, syncobj, path);
				return typechecked(_async, types)
			}
		}
		function event(target, syncobj, path) {
			typecheck(arguments, ["object", SyncedObject, "array"]);
			return mkEvent(syncobj, path)
		}
		var apiConf = {
	...
	110: [function(require, module, exports) {
		(function(global) {
			...
			function iframeExists(hostWin, id) {
				return !!hostWin.document.getElementById(id)
			}
			function nextIframeId(hostWin, startingId) {
				while (iframeExists(hostWin, global.IFRAME_ID + startingId)) startingId++;
				return global.IFRAME_ID + startingId
			}
			function buildIframe(hostWin, url) {
				typecheck(arguments, [check.win, "string"]);
				var element = hostWin.document.createElement("iframe");
				element.width = 0;
				element.height = 0;
				element.src = url;
				element.id = nextIframeId(hostWin, 0);
				hostWin.document.body.appendChild(element);
				return element
			}
			function appendToSyncApi(conf, syncobj) {
				typecheck(arguments, ["object", SyncedObject]);
				syncobj.api = syncobj.api || {};
				Object.getOwnPropertyNames(conf).forEach(function(key) {
					var path = ["api"].concat(key.split("."));
					util.pathSetObject(syncobj, conf[key](syncobj.api, syncobj, path), path)
				});
				return syncobj
			}
			function mkRelayObject(api, syncobj) {
				typecheck(arguments, ["object", SyncedObject]);
				syncobj.api = api;
				syncobj.preSendHook = function(msg) {
					msg.lastError = this.api && this.api.runtime && (this.api.runtime.lastError || null);
					return msg
				};
				return syncobj
			}
			function mkSyncedIframeObject(win, url, id) {
				typecheck(arguments, [check.win, "string", "number"]);
				var iframe = buildIframe(win, url);
				return new SyncedObject(win, iframe.contentWindow, id)
			}
			function mkSyncedParentObject(win, id) {
				return new SyncedObject(win, win.parent, id)
			}
			function mkIframeApiObject(win, api, id) {
				typecheck(arguments, [check.win, "object", "number"]);
				return mkRelayObject(api, mkSyncedParentObject(win, id))
			}
			function mkPageApiObject(win, url, apiConf, id) {
				typecheck(arguments, [check.win, "string", "object", "number"]);
				var syncobj = appendToSyncApi(apiConf, mkSyncedIframeObject(win, url, id));
				syncobj.handleReception = function(msg, process) {
					if (this.api && this.api.runtime) return withError(this.api, msg.lastError, process.bind(null, msg));
					return process(msg)
				};
				return syncobj
			}
			module.exports.SyncedObject = SyncedObject;
			...
			module.exports.conf = require("./configuration.js")
		}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
	}, {
		"./../witherror.js": 117,
		"./common.js": 108,
		"./configuration.js": 109,
		"./syncedobject.js": 111,
		"./typecheck.js": 112,
		corelib: 118
	}],
	111: [function(require, module, exports) {
		...
		function methodHandler(syncobj, winref, evt) {
			typecheck(arguments, ["object", check.remoteWin, check.domEvent]);
			var msg = evt.data;
			if (evt.source !== winref || msg.syncId !== syncobj.id) return;
			syncobj.onMessage.dispatch(evt.data);
			syncobj.pendingMethods[msg.messageId] = evt.data;
			var method = util.path2Method(syncobj, msg.path);
			if (!method) {
				throw Error("No method:" + msg.path)
			}
			function process(msg) {
				return util.path2Method(syncobj, msg.path).apply(null, msg.args)
			}
			var ret = syncobj.handleReception(msg, process);
			delete syncobj.pendingMethods[msg.messageId]
		}
		function SyncedObject(win, winref, id) {
			typecheck(arguments, [check.win, check.winref, "number"]);
			this.id = id;
			this.winref = winref;
			this.win = win;
			this.messageId = 0;
			...
			win.addEventListener("message", this.handler, true)
		}
		SyncedObject.prototype = {
			handleReception: function(msg, process) {
				return process(msg)
			},
			preSendHook: function(msg) {
				return msg
			},
			remote: function(path, args) {
				this.winref.postMessage(this.preSendHook({
			...
			rcompose: function(methods) {
				typecheck(arguments, ["array"]);
				var self = this,
					funcs = methods.map(function(m) {
						var callable = util.path2Method(self, m.path);
						return function() {
							return callable.apply(null, m.args.concat([].slice.call(arguments)))
						}
					});
			...
			remotePeekCb: function(id) {
				typecheck(arguments, ["number"]);
				var self = this;
				return function() {
					var args = [].slice.call(arguments);
					self.remote(["callbackRepo", "peek"], [id].concat(args))
				}
			},
			remotePopCb: function(id) {
				typecheck(arguments, ["number"]);
				var self = this;
				return function() {
					var args = [].slice.call(arguments);
					self.remote(["callbackRepo", "pop"], [id].concat(args))
				}
			},
			remotePop: function(id) {
				typecheck(arguments, ["number", "varany"]);
				var args = [].slice.call(arguments);
				this.remote(["callbackRepo", "pop"], args)
			},
			"const": function(val, arg) {
				return val
			},
			setProperty: function(path, val) {
				typecheck(arguments, ["array", "any"]);
				this.getProperty(path.slice(0, path.length - 1))[path[path.length]] = val;
				return true
			},
			rsetProperty: function(path, val, cb) {
				typecheck(arguments, ["array", "any", "function"]);
				this.remoteRetCb(["setProperty"], [path, val], cb)
			},
			getProperty: function(path) {
				typecheck(arguments, ["array"]);
				return path.reduce(function(obj, val) {
					return obj[val]
				}, this)
			},
			rgetProperty: function(path, cb) {
				typecheck(arguments, ["array", "function"]);
				this.remoteRetCb(["getProperty"], [path], cb)
			},
			remoteAsyncCb: function(path, args, cb) {
				typecheck(arguments, ["array", "array", "function"]);
				var cbId = this.callbackRepo.push(cb);
			...
			remoteListenCb: function(path, args, cb, getCbIds) {
				typecheck(arguments, ["array", "array", "function", "function"]);
				var localCbId = this.callbackRepo.push(cb),
					self = this;
				this.remoteRetCb(["rcompose"], [
					[{
						...
						path: ["callbackRepo", "push"],
						args: []
					}]
				], function(remoteCbId) {
					self.remoteRetCb(["rcompose"], [
						[{
							path: ["callbackRepo", "get"],
							args: [remoteCbId]
						}, {
							path: path,
							args: args
						...
						getCbIds(localCbId, remoteCbId)
					})
				})
			},
			remoteUnlistenCb: function(path, args, cb, localCbId, remoteCbId) {
				typecheck(arguments, ["array", "array", "callback", "number", "number"]);
				var self = this;
				self.callbackRepo.silence(localCbId);
				this.remoteRetCb(["rcompose"], [
					[{
						path: ["callbackRepo", "extract"],
						args: [remoteCbId]
					}, {
						path: path,
						args: args
					...
					self.callbackRepo.extract(localCbId);
					return cb.apply(null, arguments)
				})
			},
			remoteRetCb: function(path, args, cb) {
				typecheck(arguments, ["array", "array", "callback"]);
				var cbId = this.callbackRepo.push(cb);
				this.remote(["rcompose"], [
					[{
						path: path,
	...
	112: [function(require, module, exports) {
		...
		module.exports = {
			...
			usbTransferInfo: "object",
			usbGenericTransferInfo: "object",
			usbOptions: "object",
			remoteWin: remoteWin,
			win: win,
	...
	113: [function(require, module, exports) {
		(function(global) {
			var hs = require("./iframe/index.js"),
			...
			function setupIndirectSyncobj(pageAvailable) {
				typecheck(arguments, [PageAvailable]);
				var availabilityConf = {
					onFound: hs.conf.event,
					onLost: hs.conf.event,
					onError: hs.conf.event,
					init: hs.conf.async(["function"]),
					checkVersion: hs.conf.async(["function"]),
					canHave: hs.conf.async(["function"]),
					state: hs.conf.valueAsAsync,
					connect: hs.conf.fnAsAsync,
					connectionId: hs.conf.fnAsAsync,
					disconnect: hs.conf.async(["function"])
				};
				return hs.mkPageApiObject(pageAvailable.win, pageAvailable.url, availabilityConf, 0)
			}
			function relayEvent(pa, eventName, syncAvailable) {
				typecheck(arguments, [PageAvailable, "string",
				{
					api: "object"
				}]);
				if (!syncAvailable) {
					console.error("No syncAvailable object to use to relay event.");
					return
				}
				function relayDispatch() {
					pa[eventName].dispatch.apply(pa[eventName], arguments)
				}
				pa.handlers[eventName] = relayDispatch;
				syncAvailable.api[eventName].addListener(relayDispatch)
			}
			function unrelayEvent(pa, eventName, syncAvailable) {
				typecheck(arguments, [PageAvailable, "string",
				{
					api: "object"
				}]);
				if (!syncAvailable) console.error("No syncAvailable object to use to unrelay event.");
				else syncAvailable.api[eventName].removeListener(pa.handlers[eventName]);
				delete pa.handlers[eventName]
			}
			function connectInternal(ifavailable, syncAvailable, retries, interval, cb) {
				typecheck(arguments, [PageAvailable, hs.SyncedObject, "number", "number", "callback"]);
				if (retries <= 0) {
					ifavailable.onError.dispatch(errors.IFRAME_CONNECTION.copy());
					return
				}
				var r = scheduler.setTimeout(function() {
					connectInternal(ifavailable, syncAvailable, retries - 1, interval, cb)
				}, interval);
				ping(syncAvailable, function() {
					scheduler.clearTimeout(r);
					if (ifavailable.state >= NO_APP_CONNECTED) {
						cb();
						return
					}
					ifavailable.setSyncAvailable(syncAvailable);
					cb()
				}, retries)
			}
			function ping(available, cb, retries) {
				available.remoteRetCb(["const"], [true, true], cb)
			}
			function PageAvailable(url, win) {
				Available.call(this);
				...
				Object.defineProperty(this, "state", {
					...
					configurable: false,
					get: function() {
						if (this.api && this.syncAvailable) return CONNECTED;
						if (!this.api && this.syncAvailable) return NO_APP_CONNECTED;
						if (!this.api && !this.syncAvailable) return DISCONNECTED;
						console.error("Undefined state: {api:" + !! this.api + ", sync:" + !! this.syncAvailable + "}");
						this.deinitChromeApi();
						return DISCONNECTED
					}
				});
				var self = this;
				this.onFound.modifyDispatcher(function(dispatch) {
					return function(l, varargs) {
						var args = [].slice.call(arguments);
						self.probeState(function(iframeState) {
							if (iframeState === CONNECTED) {
								self.initChromeApi(function() {
			...
			PageAvailable.prototype = Object.create(Available.prototype);
			PageAvailable.prototype.canHave = function(done) {
				if (!global.location || !global.location.hostname) {
					done(false);
					return
				}
				var domain = global.location.hostname.split("."),
					self = this;
				if (domain[domain.length - 2] === "codebender") {
					done(false);
					return
				}
				this.withInited(function(ok) {
					...
					self.syncAvailable.api.canHave(function(ok) {
						done(ok)
					})
				})
			};
			PageAvailable.prototype.checkVersion = function(callback) {
				var self = this;
				Available.prototype.checkVersion.call(this, function(ok) {
					if (!ok) {
						callback(ok);
					...
					self.syncAvailable.api.checkVersion(callback)
				})
			};
			PageAvailable.prototype.connect = function(timeout) {
				var self = this,
					syncAvailable = this.syncAvailable || setupIndirectSyncobj(this);
				connectInternal(this, syncAvailable, 10, timeout, function() {
					self.syncAvailable.api.connect.async(timeout, function() {
						self.log.log("Remote connect called")
					})
				})
			};
			PageAvailable.prototype.messageHandler = function(msg) {
				var self = this;
				if (self.state < NO_APP_CONNECTED) return;
				scheduler.clearTimeout(this.keepaliveState.timeoutHandle);
				this.keepaliveState.timeoutHandle = scheduler.setTimeout(function() {
					if (self.state < NO_APP_CONNECTED) return;
					self.probeState(function(iframeState) {
						if (self.state > iframeState) self.deinitChromeApi();
						if (self.state < iframeState) self.onError.dispatch(errors.ILLEGAL_IFRAME_STATE.copy({
							page: self.state,
							iframe: iframeState
						}))
					})
			...
			(function() {
				var probeQueue = [];
				PageAvailable.prototype.probeState = function(cb) {
					var self = this;
					...
					function probeSuccess(iframeState) {
						scheduler.clearTimeout(to);
						probeQueue.forEach(function(fn) {
							fn(iframeState)
						});
						probeQueue = []
					}
					...
					probeQueue.push(cb);
					if (probeQueue.length !== 1) return;
					var to = scheduler.setTimeout(probeFail, 2e3);
					this.syncAvailable.api.state.get(probeSuccess)
				}
			})();
			PageAvailable.prototype.disconnect = function(done) {
				if (this.state <= DISCONNECTED) {
					done && done();
					return
				}
				this.syncAvailable.api.disconnect(done ||
				function() {});
				this.setSyncAvailable(null)
			};
			PageAvailable.prototype.cleanKeepalive = function() {
				scheduler.clearTimeout(this.keepaliveState.timeoutHandle)
			};
			PageAvailable.prototype.eventModifier = function(maybeSyncAvailable) {
				typecheck(arguments, ["any"]);
				if (!maybeSyncAvailable) return unrelayEvent.bind(null, this);
				if (!this.syncAvailable) return relayEvent.bind(null, this);
				if (maybeSyncAvailable !== this.syncAvailable) return function() {
					unrelayEvent.apply(null, arguments);
					relayEvent.apply(null, arguments)
				}.bind(null, this)
			};
			PageAvailable.prototype.setSyncAvailable = function(maybeSyncAvailable) {
				typecheck(arguments, ["any"]);
				var self = this,
					action = this.eventModifier(maybeSyncAvailable),
					sa = maybeSyncAvailable || this.syncAvailable;
				if (sa === null) return null;
				if (!maybeSyncAvailable) {
					this.syncAvailable.onMessage.removeListener(this.messageHandlerBound);
					this.deinitChromeApi()
				}
				if (maybeSyncAvailable) maybeSyncAvailable.onMessage.addListener(this.messageHandlerBound);
				action("onError", sa);
				action("onLost", sa);
				action("onFound", sa);
				this.syncAvailable = maybeSyncAvailable;
				return sa
			};
			PageAvailable.prototype.initChromeApi = function(cb) {
				var self = this;
				this.syncConnectionId(function() {
					if (self.state < NO_APP_CONNECTED) {
						self.deinitChromeApi();
						self.onError.dispatch(errors.LOST_DURING_IFRAME_INIT.copy());
						return
					}
					if (this.api) {
						cb();
					...
					var serialApiConf = util.prefixObjectKeys("api.", hs.conf.apiConf);
					hs.appendToSyncApi(serialApiConf, self.syncAvailable);
					self.api = self.syncAvailable.api.api;
					cb()
				})
			};
			PageAvailable.prototype.syncConnectionId = function(cb) {
				var self = this;
				if (!this.syncAvailable) {
					this.deinitConnectionId();
					cb();
					return
				}
				this.syncAvailable.api.connectionId.async(function(cid) {
					self.connectionId = function() {
						return cid
					};
					cb()
				})
			};
			PageAvailable.prototype.deinitConnectionId = function() {
				if (this.connectionId()) delete this.connectionId
			};
			PageAvailable.prototype.connectionId = function() {
				return null
			};
			PageAvailable.prototype.deinitChromeApi = function() {
				this.api = null
			};

			function provideAvailabilityToPage(available, win) {
				this.pageAvailability = hs.mkIframeApiObject(win || global, available, 0)
			}
			module.exports.setupIndirectSyncobj = setupIndirectSyncobj;
			...
			module.exports.provideAvailabilityToPage = provideAvailabilityToPage
		}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
	}, {
		"./availability.js": 103,
		"./errors.js": 106,
		"./iframe/common.js": 108,
		"./iframe/index.js": 110,
		corelib: 118
	}],
	114: [function(require, module, exports) {
		(function(global) {
			var PollAvailable = require("./pollavailability.js").PollAvailable,
				NpapiChrome = require("./../backends/npapi-plugin").NpapiChrome;

			function buildPlugin(win) {
				var plugin = global.document.getElementById("plugin0");
				...
				global.document.body.appendChild(plugin);
				return plugin
			}
			function NpapiAvailable() {
				PollAvailable.call(this);
				this.createPluginObject()
			}
			NpapiAvailable.prototype = Object.create(PollAvailable.prototype);
			NpapiAvailable.prototype.canHave = function(done) {
				if (!global.document || !global.document.getElementById || !global.document.createElement || !global.document.body || !global.document.body.appendChild) {
					done(false);
					return
				}
				var plugin = buildPlugin(),
					result = !! plugin.Serial;
				if (!result) global.document.body.removeChild(plugin);
				done(result)
			};
			NpapiAvailable.prototype.checkVersion = function(cb) {
				cb(true)
			};
			NpapiAvailable.prototype.connectionId = function() {
				return this.element_ ? this.element_.instance_id : null
			};
			NpapiAvailable.prototype.isConnected = function() {
				return !!(this.element_.probeUSB && typeof this.element_.probeUSB() === "string")
			};
			NpapiAvailable.prototype.createPluginObject = function() {
				this.element_ = buildPlugin();
				this.element_.id = "plugin0";
				this.api = new NpapiChrome(this.element_)
			};
			module.exports.NpapiAvailable = NpapiAvailable
		}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
	}, {
		"./../backends/npapi-plugin": 93,
		"./pollavailability.js": 116
	}],
	115: [function(require, module, exports) {
		(function(global) {
			var compareVersions = require("corelib").compareVersions,
				Event = require("corelib").Event,
				typecheck = require("corelib").typecheck,
				NpapiAvailable = require("./npapiavailability.js").NpapiAvailable,
				PageAvailable = require("./iframeavailability.js").PageAvailable,
				AppAvailable = require("./appavailability.js").AppAvailable;
			var badOsMessage = '<i class="icon-warning-sign"></i> To program your Arduino from your browser, please use <a href="http://www.google.com/chrome/" target="_blank">Google Chrome</a>/Chromium on Windows, Mac, Linux (version 41 and above) or Chrome OS (version 41 and above) or <a href="http://www.mozilla.org/en-US/firefox/" target="_blank">Mozilla Firefox</a> on Windows, Mac or Linux.';
			var badBrowserMessage = '<i class="icon-warning-sign"></i> To program your Arduino from your browser, please use <a href="http://www.google.com/chrome/" target="_blank">Google Chrome</a>/Chromium (version 41 and above on Linux) or <a href="http://www.mozilla.org/en-US/firefox/" target="_blank">Mozilla Firefox</a> (32bit only on Windows).';
			var installBackend = '<a target="_blank" href="https://codebender.cc/static/plugin">Learn more</a> To program your Arduino from your browser, install the codebender plugin or app.';
			var updateBackend = '<a target="_blank" href="https://codebender.cc/static/plugin">Learn more</a> To program your Arduino from your browser, install the codebender plugin or app.';

			function pipeSucc(if_, fn) {
				typecheck(arguments, ["function", "function"]);
				return function(success, fail) {
					if_(function pipeSucc_(succList) {
						fn(succList, success, fail)
					}, fail)
				}
			}
			function pipeFail(if_, fn) {
				typecheck(arguments, ["function", "function"]);
				return function(success, fail) {
					if_(success, function pipeFail_(failList) {
						fn(failList, success, fail)
					})
				}
			}
			function both(if1, if2) {
				typecheck(arguments, ["function", "function"]);
				return function bothConditional_(success, fail) {
					typecheck(arguments, ["function", "function"]);
					if1(function bothSucc1_(succ1) {
						if2(function bothSucc2_(succ2) {
							success(succ1.concat(succ2))
						}, fail)
					}, fail)
				}
			}
			function anyOf(if1, if2) {
				typecheck(arguments, ["function", "function"]);
				return function anyOfConditional_(success, fail) {
					typecheck(arguments, ["function", "function"]);
					if1(success, function anyOfErr1_(err1) {
						if2(success, function anyOfErr2_(err2) {
							fail(err1.concat(err2))
						})
					})
				}
			}
			function curry(if_, varArgs) {
				var args = [].slice.call(arguments, 1);
				if (args.length == 0) return if_;
				return curry.apply(null, [if_.bind(null, args[0])].concat(args.slice(1)))
			}
			function not(if_) {
				return function not_(s, f) {
					if_(f, s)
				}
			}
			function or(varArgs) {
				return [].reduce.call(arguments, function or_(ret, f) {
					return anyOf(ret, f)
				})
			}
			function and(varArgs) {
				return [].reduce.call(arguments, function and_(ret, f) {
					return both(ret, f)
				})
			}
			function fail(val) {
				return function fail_(s, f) {
					f([val])
				}
			}
			function succeed(val) {
				return function succeed_(s, f) {
					s([val])
				}
			}
			function id(x) {
			...
			function keys(errs, key) {
				return errs.map(function(e) {
					return e[key]
				}).filter(id)
			}
			var onWhichBrowserLoad = new Event,
				scriptCreated = false,
				scriptLoaded = false;

			function getWhichBrowser(cb) {
				if (global.WhichBrowser) {
					cb(new global.WhichBrowser);
					return
				}
				if (scriptLoaded) console.error("While the WhichBrowser script was loaded," + "the Browser object was not created");
				onWhichBrowserLoad.addListener(cb);
				if (document.getElementById("which-browser-script")) return;
				if (scriptCreated) console.error("Creating duplicate WhichBrowser script element...");
				scriptCreated = true;
				(function makeWhichBrowser_() {
					var url = "//api.whichbrowser.net/rel/detect.js";
					var p = [],
						e = 0,
						f = 0;
					...
					s.onload = function whichBrowserOnload_() {
						onWhichBrowserLoad.dispatch(new global.WhichBrowser);
						scriptLoaded = true
					};
			...
			function fromWhichBrowser(method) {
				return function actualMethod(varArgs) {
					var args = arguments,
						obj = {
							wbMethod: method,
							args: [].slice.call(args)
						};
					return function whichBrowserConditional(success, fail) {
						getWhichBrowser(function gotWhichBrowser(result) {
							if (result[method].apply(result, args)) {
								success([obj]);
								return
							}
							fail([obj])
			...
			var isBrowser = fromWhichBrowser("isBrowser");
			var isOs = fromWhichBrowser("isOs");
			var UNSUPPORTED_OS = {
				name: "UNSUPPORTED_OS",
				message: badOsMessage
			};
			var UNSUPPORTED_BROWSER = {
				name: "UNSUPPORTED_BROWSER",
				message: badBrowserMessage
			};
			var BAD_CHROME_VERSION = {
				name: "BAD_CHROME_VERSION",
				message: badBrowserMessage
			};
			var UNSUPPORTED_64BIT = {
			...
			var UPDATE_APP = {
				name: "UPDATE_APP",
				message: updateBackend
			};
			var INSTALL_APP = {
				name: "INSTALL_APP",
				message: installBackend
			};
			var UPDATE_NPAPI = {
				name: "UPDATE_NPAPI",
				message: updateBackend
			...
			var BAD_DOMAIN = {
				message: "Need to be at *.codebender.cc to contact app. We are at " + (global.location || {}).hostname
			};

			function isWin64(success, fail) {
				typecheck(arguments, ["function", "function"]);
			...
			var isChrome = curry(isBrowser, "Chrome");
			var isChromium = curry(isBrowser, "Chromium");
			var isFirefoxLike = or(isBrowser("Firefox"), isBrowser("Iceweasel"));
			var linuxNames = ["Unix", "Linux", "FreeBSD", "OpenBSD", "NetBSD", "Solaris", "Debian", "Fedora", "Gentoo", "gNewSense", "Kubuntu", "Mandriva", "Mageia", "Red Hat", "Slackware", "SUSE", "Turbolinux", "Ubuntu"];
			var isLinux = or.apply(null, linuxNames.map(isOs));
			var isValidOs = or(isOs("Windows"), isOs("OS X"), isOs("Chrome OS"), isLinux, fail(UNSUPPORTED_OS));

			function isAtCodebenderCc(success, fail) {
				if (!global.location || !global.location.hostname) {
					fail([{
						notInBrowser: true
					}]);
			...
			function checkVersion(versionFail) {
				typecheck(arguments, ["object"]);
				return function doCheckVersion_(succList, success, fail) {
					typecheck(arguments, ["array", "function", "function"]);
					var avail = keys(succList, "available")[0];
					avail.checkVersion(function checkedVersion_(ok) {
						if (ok) {
							success(succList);
							return
						}
			...
			function canHave(Available, failMessage, argument) {
				typecheck(arguments, ["function", "object", "any"]);
				return function canHaveConditional_(success, fail) {
					typecheck(arguments, ["function", "function"]);
					var avail = new Available(argument);
					avail.canHave(function canHaveResult_(yes) {
						if (yes) {
							success([{
								available: avail
							}]);
			...
			function isChromeLike(pred, ver) {
				typecheck(arguments, ["string", "string"]);
				return or(isChrome(pred, ver), isChromium(pred, ver))
			}
			var isValidChrome = and(or(isBrowser("Chrome"), isBrowser("Chromium")), or(isOs("Chrome OS"), isChromeLike(">=", "42"), and(isLinux, isChromeLike(">=", "41")), fail(BAD_CHROME_VERSION)));
			var isValidFirefox = isFirefoxLike;
			var isValidBrowser = and(or(not(and(isValidFirefox, isWin64)), fail(UNSUPPORTED_64BIT)), or(isValidChrome, isValidFirefox, fail(UNSUPPORTED_BROWSER)));
			var isChromeSuitableForProgrammers = or(isChromeLike(">=", "43"), fail(NO_PROGRAMMERS));

			function getChromeAvailability(arg) {
				return and(isValidChrome, pipeSucc(or(and(isAtCodebenderCc, canHave(AppAvailable, INSTALL_APP, arg)), canHave(PageAvailable, INSTALL_APP, arg)), checkVersion(UPDATE_APP)))
			}
			function getFirefoxAvailability(arg) {
				return pipeSucc(and(isValidFirefox, canHave(NpapiAvailable, INSTALL_NPAPI, arg)), checkVersion(UPDATE_NPAPI))
			}
			function getAvailabilityConditional(arg) {
				return and(isValidOs, isValidBrowser, or(getFirefoxAvailability(arg), getChromeAvailability(arg)))
			}
			function getAvailability(arg, succ, fail) {
				return getAvailabilityConditional(arg)(function(succList) {
					succ(keys(succList, "available").reverse()[0], succList)
				}, function(failList) {
					fail(keys(failList, "message").reverse()[0], failList)
				})
			}
			...
			module.exports.getAvailabilityConditional = getAvailabilityConditional
		}).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
	}, {
		"./appavailability.js": 102,
		"./iframeavailability.js": 113,
	...
	116: [function(require, module, exports) {
		...
		function PollAvailable() {
			Available.call(this);
			this.pollTimeout = 1e3
		}
		PollAvailable.prototype = Object.create(Available.prototype);
		PollAvailable.prototype.init = function() {
			var oldIsConnected = this.isConnected;
			this.isConnected = function() {
				this.isConnected = oldIsConnected;
				return false
			};
			Available.prototype.init.apply(this, arguments)
		};
		PollAvailable.prototype.connect = function() {
			var self = this;

			function eventLoop() {
				if (self.state >= CONNECTED && !self.isConnected()) {
					self.disconnect(function() {
						self.onLost.dispatch()
					});
					return
				}
				scheduler.setTimeout(eventLoop, self.pollTimeout)
			}
		...
		PollAvailable.prototype.disconnect = function(done) {
			if (this.state > DISCONNECTED) {
				this.state = DISCONNECTED
			}
			if (done) done()
		};
		module.exports.PollAvailable = PollAvailable
	}, {
		"./availability.js": 103,
		corelib: 118
	}],
	117: [function(require, module, exports) {
		...
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/babelfish/backends/chrome-app/src/error.js": 73
	}],
	118: [function(require, module, exports) {
		arguments[4][30][0].apply(exports, arguments)
	}, {
		"./lib/data/base64.js": 119,
		"./lib/data/data.js": 120,
		"./lib/data/errors.js": 121,
		"./lib/data/intelhex.js": 122,
		"./lib/errno.js": 123,
		"./lib/event.js": 124,
		"./lib/io/codecsocket.js": 126,
		"./lib/io/errors.js": 127,
		"./lib/logging.js": 129,
		"./lib/scheduler.js": 130,
		"./lib/settings.js": 131,
		"./lib/status.js": 132,
		"./lib/transactions/connection/errors.js": 134,
		"./lib/transactions/connection/manager.js": 135,
		"./lib/transactions/errors.js": 136,
		"./lib/transactions/fsm.js": 137,
		"./lib/transactions/serialtransaction.js": 138,
		"./lib/transactions/sockettransaction.js": 139,
		"./lib/transactions/usbtransaction.js": 141,
		"./lib/typecheck.js": 142,
		"./lib/util.js": 143,
		"./lib/wrapper.js": 144,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/index.js": 30
	}],
	119: [function(require, module, exports) {
		...
		"./data.js": 120,
		"./errors.js": 121,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/data/base64.js": 31
	}],
	120: [function(require, module, exports) {
		arguments[4][32][0].apply(exports, arguments)
	}, {
		"./../scheduler.js": 130,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/data/data.js": 32
	}],
	121: [function(require, module, exports) {
		arguments[4][33][0].apply(exports, arguments)
	}, {
		"./../errno.js": 123,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/data/errors.js": 33
	}],
	122: [function(require, module, exports) {
		...
		"./data.js": 120,
		"./errors.js": 121,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/data/intelhex.js": 34
	}],
	123: [function(require, module, exports) {
		arguments[4][35][0].apply(exports, arguments)
	}, {
		"./settings.js": 131,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/errno.js": 35
	}],
	124: [function(require, module, exports) {
		arguments[4][36][0].apply(exports, arguments)
	}, {
		"./scheduler.js": 130,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/event.js": 36
	}],
	125: [function(require, module, exports) {
		...
		"./errors.js": 127,
		"./serial.js": 128,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/io/buffer.js": 37
	}],
	126: [function(require, module, exports) {
		...
		"./errors.js": 127,
		"./serial.js": 128,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/io/codecsocket.js": 38
	}],
	127: [function(require, module, exports) {
		arguments[4][39][0].apply(exports, arguments)
	}, {
		"./../errno.js": 123,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/io/errors.js": 39
	}],
	128: [function(require, module, exports) {
		...
		"./../util.js": 143,
		"./errors.js": 127,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/io/serial.js": 40
	}],
	...
	132: [function(require, module, exports) {
		...
		"./settings.js": 131,
		"./util.js": 143,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/status.js": 44
	}],
	133: [function(require, module, exports) {
		module.exports = require(45)
	}, {
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/super.js": 45
	}],
	134: [function(require, module, exports) {
		arguments[4][46][0].apply(exports, arguments)
	}, {
		"./../../errno.js": 123,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/transactions/connection/errors.js": 46
	}],
	135: [function(require, module, exports) {
		...
		"./../../scheduler.js": 130,
		"./errors.js": 134,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/transactions/connection/manager.js": 47
	}],
	136: [function(require, module, exports) {
		arguments[4][48][0].apply(exports, arguments)
	}, {
		"./../errno.js": 123,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/transactions/errors.js": 48
	}],
	137: [function(require, module, exports) {
		...
		"./errors.js": 136,
		"./status.js": 140,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/transactions/fsm.js": 49
	}],
	138: [function(require, module, exports) {
		...
		"./../logging.js": 129,
		"./../util": 143,
		"./connection/manager.js": 135,
		"./errors.js": 136,
		"./sockettransaction.js": 139,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/transactions/serialtransaction.js": 50
	}],
	139: [function(require, module, exports) {
		...
		"./errors.js": 136,
		"./fsm.js": 137,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/transactions/sockettransaction.js": 51
	}],
	140: [function(require, module, exports) {
		arguments[4][52][0].apply(exports, arguments)
	}, {
		"./../status.js": 132,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/transactions/status.js": 52
	}],
	141: [function(require, module, exports) {
		...
		"./errors.js": 136,
		"./fsm.js": 137,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/transactions/usbtransaction.js": 53
	}],
	...
	144: [function(require, module, exports) {
		...
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/wrapper.js": 56
	}],
	145: [function(require, module, exports) {
		arguments[4][30][0].apply(exports, arguments)
	}, {
		"./lib/data/base64.js": 146,
		"./lib/data/data.js": 147,
		"./lib/data/errors.js": 148,
		"./lib/data/intelhex.js": 149,
		"./lib/errno.js": 150,
		"./lib/event.js": 151,
		"./lib/io/codecsocket.js": 153,
		"./lib/io/errors.js": 154,
		"./lib/logging.js": 156,
		"./lib/scheduler.js": 157,
		"./lib/settings.js": 158,
		"./lib/status.js": 159,
		"./lib/transactions/connection/errors.js": 161,
		"./lib/transactions/connection/manager.js": 162,
		"./lib/transactions/errors.js": 163,
		"./lib/transactions/fsm.js": 164,
		"./lib/transactions/serialtransaction.js": 165,
		"./lib/transactions/sockettransaction.js": 166,
		"./lib/transactions/usbtransaction.js": 168,
		"./lib/typecheck.js": 169,
		"./lib/util.js": 170,
		"./lib/wrapper.js": 171,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/index.js": 30
	}],
	...
	165: [function(require, module, exports) {
		...
		"./../logging.js": 156,
		"./../util": 170,
		"./connection/manager.js": 162,
		"./errors.js": 163,
		"./sockettransaction.js": 166,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/transactions/serialtransaction.js": 50
	}],
	...
	173: [function(require, module, exports) {
		...
		function Connection(port, baudrate, api) {
			...
			this.onConnected.modifyDispatcher(function(d) {
				return function(l, va) {
					var args = arguments;
					self.api.serial.setControlSignals(self.info.connectionId, {
						dtr: true,
						rts: false
					}, function(ok) {
			...
			this.isTaken(this.port, function(taken) {
				if (taken) {
					self.onDisconnected.dispatch(errors.RESOURCE_BUSY_FROM_CHROME);
					return
				}
		...
		Connection.prototype = {
			errorDispatcher: function(listener, error) {
				if (error.error !== "device_lost") {
					listener(errors.UNKNOWN_MONITOR_ERROR.copy({
						apiError: error
					}));
					return
				}
				listener(errors.SERIAL_MONITOR_DEVICE_LOST.copy())
			},
			...
			connect: function(port, baudrate) {
				...
				this.api.serial.connect(port, {
					...
					if (!info) {
						self.disconnect(errors.SERIAL_MONITOR_CONNECT);
						return
					}
			...
			disconnect: function(error) {
				...
				function disconnect(err) {
					...
					self.onDisconnected.dispatch(err || errors.SUCCESS);
				...
				self.api.serial.getConnections(function(cnx) {
					if (!cnx.some(function(c) {
						...
						disconnect(error || errors.SERIAL_MONITOR_DEVICE_LOST);
						return
					}
					self.api.serial.disconnect(self.info.connectionId, function(ok) {
						var err = null;
						if (!ok) {
							err = errors.SERIAL_MONITOR_DISCONNECT
						}
	...
	176: [function(require, module, exports) {
		...
		Monitor.prototype = {
			write: function(strData, cb) {
				...
				this.onError.display(errors.SERIAL_MONITOR_WRITE_BEFORE_CONNECT);
				cb()
			},
	...
	177: [function(require, module, exports) {
		...
		NormalState.prototype._handler = function(msg) {
			if (msg.connectionId !== this.reader.connectionId) return;
			var arr = bufToBin(msg.data);
		...
		Reader.prototype.readHandler_ = function(message) {
			var stringMessage = bufToBin(message);
	...
	178: [function(require, module, exports) {
		var getLog = require("corelib").getLog;
		...
		function stateFactory(handler, destroy, data) {
			...
			ret.prototype._handler = handler ||
			function() {};
			ret.prototype._destroy = destroy ||
			function() {};
			return ret
		}
	...
	179: [function(require, module, exports) {
		...
		function ReceiveErrorEvent(connectionId, api) {
			...
			if (0) api.runtime.getPlatformInfo(function(platform) {
				if (platform.os == "win") {
		...
		function utf8ArrayToStr(array) {
			...
			while (i < len) {
				...
				if (i + extraLength > len) {
					...
					for (; i < len; i++) if (array[i] >> 6 != 2) break;
					if (i != len) continue;
					return {
						result: out,
						leftovers: leftovers
		...
		Writer.prototype = {
			...
			write: function(strData, cb) {
				if (!this.connectionId) {
					...
					if (cb) scheduler.setTimeout(cb);
					return
				}
				var self = this,
					data = util.strToUtf8Array(strData);
				this.api.serial.send(this.connectionId, binToBuf(data), function(sendInfo) {
					self.log.log("Sent data of length:", data.length);
					if (!sendInfo || sendInfo.error) {
						self.onWriteFail.dispatch(errors.SERIAL_MONITOR_WRITE);
						return
					}
					if (cb) cb(sendInfo)
				})
	...
	183: [function(require, module, exports) {
		...
		"./lib/data/base64.js": 184,
		"./lib/data/data.js": 185,
		"./lib/data/errors.js": 186,
		"./lib/data/intelhex.js": 187,
		"./lib/errno.js": 188,
		"./lib/event.js": 189,
		"./lib/io/codecsocket.js": 191,
		"./lib/io/errors.js": 192,
		"./lib/logging.js": 194,
		"./lib/scheduler.js": 195,
		"./lib/settings.js": 196,
		"./lib/status.js": 197,
		"./lib/transactions/connection/errors.js": 199,
		"./lib/transactions/connection/manager.js": 200,
		"./lib/transactions/errors.js": 201,
		"./lib/transactions/fsm.js": 202,
		"./lib/transactions/serialtransaction.js": 203,
		"./lib/transactions/sockettransaction.js": 204,
		"./lib/transactions/usbtransaction.js": 206,
		"./lib/typecheck.js": 207,
		"./lib/util.js": 208,
		"./lib/wrapper.js": 209,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/index.js": 30
	}],
	...
	203: [function(require, module, exports) {
		...
		"./../logging.js": 194,
		"./../util": 208,
		"./connection/manager.js": 200,
		"./errors.js": 201,
		"./sockettransaction.js": 204,
		"/Users/drninjabatman/Projects/Codebendercc/BFSuite/cbcf_backend/node_modules/avrdudejs/node_modules/corelib/lib/transactions/serialtransaction.js": 50
	}],
